...
(function ($, undefined) {
    ...
    //$("[data-localize]").localize("mydoor", { language: "en", pathPrefix: "/Scripts/Lib/jquery-localize/lang", skipLanguage: "en-US" });
    //window.localizeObj = ($ && $.localize && $.localize.data.mydoor) ? $.localize.data.mydoor : undefined;

    
    //if (window.localizeObj == undefined) {
    //    alert("Error in loading the language resource file.");
    //}


    // kendo grid localization implimented . Var tempLang value declare _sharedSeuredd.vbhtml. srini 
    ...
    if (tempLang == "1") {
        $("[data-localize]").localize("mydoor", { language: "fr", pathPrefix: "/Scripts/Lib/jquery-localize/lang", skipLanguage: "fr-US" });
        window.localizeObj = ($ && $.localize && $.localize.data.mydoor) ? $.localize.data.mydoor : undefined;

    }

    if (tempLang == "2") {
        $("[data-localize]").localize("mydoor", { language: "es", pathPrefix: "/Scripts/Lib/jquery-localize/lang", skipLanguage: "es-US" });
        window.localizeObj = ($ && $.localize && $.localize.data.mydoor) ? $.localize.data.mydoor : undefined;
    ...
    function testRx(e, t, n) {
        for (var i in t)
            if (t.hasOwnProperty(i) && t[i].test(e)) return i;
    ...
    var Observable = Class.extend({
        ...
        unbind: function (e, t) {
            ...
            if (e === undefined) r._events = {};
                ...
                if (t)
                    for (n = 0, i = a.length; i > n; n++) a[n] === t && a.splice(n, 1);
                else r._events[e] = [];
            return r
        }
    }),
    ...
    function () {
        ...
        function t(a, o) {
            ...
            if (f === OBJECT) {
                ...
                if (r && typeof r === OBJECT)
                    for (u = r.length, l = 0; u > l; l++) typeof r[l] === STRING && (d = r[l], c = t(d, m), c && p.push(e(d) + (n ? ": " : ":") + c));
                else
                    for (d in m) Object.hasOwnProperty.call(m, d) && (c = t(d, m), c && p.push(e(d) + (n ? ": " : ":") + c));
                return c = 0 === p.length ? "{}" : n ? "{\n" + n + p.join(",\n" + n) + "\n" + h + "}" : "{" + p.join(",") + "}", n = h, c
            }
        }
        ...
        typeof Date.prototype.toJSON !== FUNCTION && (Date.prototype.toJSON = function () {
            ...
            if (n = "", i = "", typeof o === NUMBER)
                for (s = 0; o > s; s += 1) i += " ";
            else typeof o === STRING && (i = o); if (r = a, a && typeof a !== FUNCTION && (typeof a !== OBJECT || typeof a.length !== NUMBER)) throw Error("JSON.stringify");
            return t("", {
                "": e
            })
        })
    ...
    function () {
        ...
        function i(e, n, i) {
            i = t(i);
            var r, h, m, g, v, _, k, b, w, y, x, C, T, S, F, D, E, N, A, I, R = i.numberFormat,
                z = R.groupSize[0],
                H = R[c],
                O = R[d],
                M = R.decimals,
            ...
            if (v = a.exec(n)) {
                if (n = v[1].toLowerCase(), h = "c" === n, m = "p" === n, (h || m) && (R = h ? R.currency : R.percent, z = R.groupSize[0], H = R[c], O = R[d], M = R.decimals, r = R.symbol, P = R.pattern[L ? 0 : 1]), g = v[2], g && (M = +g), "e" === n) return g ? e.toExponential(M) : e.toExponential();
                if (m && (e *= 100), e = e.toFixed(M), e = e.split(d), _ = e[0], k = e[1], L && (_ = _.substring(1)), W = _, b = _.length, b >= z)
                    for (W = l, y = 0; b > y; y++) y > 0 && 0 === (b - y) % z && (W += H), W += _.charAt(y);
            ...
            if (L && (e = -e), n = n.split(";"), L && n[1]) n = n[1], S = !0;
            ...
            } else n = n[0]; if ((n.indexOf("'") > -1 || n.indexOf('"') > -1) && (n = n.replace(o, function (e) {
                return B.push(e), f
            })), N = n.indexOf("%"), m = -1 != N, h = -1 != n.indexOf("$"), m && ("\\" !== n[N - 1] ? e *= 100 : n = n.split("\\").join("")), (h || m) && (R = h ? R.currency : R.percent, z = R.groupSize[0], H = R[c], O = R[d], M = R.decimals, r = R.symbol), T = n.indexOf(c) > -1, T && (n = n.replace(s, l)), F = n.indexOf(d), x = n.length, -1 != F ? (E = n.lastIndexOf(p), D = n.lastIndexOf(u), k = ("" + e).split(d)[1] || l, D > E && k.length > D - E ? y = D : -1 != E && E >= F && (y = E), y && (e = e.toFixed(y - F))) : e = e.toFixed(0), D = n.indexOf(u), A = E = n.indexOf(p), V = -1 == D && -1 != E ? E : -1 != D && -1 == E ? D : D > E ? E : D, D = n.lastIndexOf(u), E = n.lastIndexOf(p), I = -1 == D && -1 != E ? E : -1 != D && -1 == E ? D : D > E ? D : E, V == x && (I = V), -1 != V) {
                if (W = ("" + e).split(d), _ = W[0], k = W[1] || l, b = _.length, w = k.length, T)
                    if (b === z && F - A > b) _ = H + _;
                    else if (b > z) {
                    for (W = l, y = 0; b > y; y++) y > 0 && 0 === (b - y) % z && (W += H), W += _.charAt(y);
                    _ = W
                }
                for (e = n.substring(0, V), L && !S && (e += "-"), y = V; x > y; y++) {
                    if (C = n.charAt(y), -1 == F) {
                        if (b > I - y) {
                            e += _;
                            break
                ...
                if (I >= V && (e += n.substring(I + 1)), h || m) {
                    for (W = l, y = 0, x = e.length; x > y; y++) C = e.charAt(y), W += "$" === C || "%" === C ? r : C;
                    e = W
                }
                if (B[0])
                    for (x = B.length, y = 0; x > y; y++) e = e.replace(f, B[y])
            }
            return e
        }
    ...
    function () {
        ...
        function r(t, r, a) {
            ...
            var o, d, c, p, f, h, m, g, v, _, k, b, w, y = function (e) {
                    ...
                    var n = u[e] || RegExp("^\\d{1," + e + "}"),
                        i = t.substr(H, e).match(n);
                    return i ? (i = i[0], H += i.length, parseInt(i, 10)) : null
                }, C = function (e) {
                    for (var n, i, r = 0, a = e.length; a > r; r++)
                        if (n = e[r], i = n.length, t.substr(H, i) == n) return H += i, r + 1;
                    return null
                }, T = function () {
                    var e = !1;
                    return t.charAt(H) === r[z] && (H++, e = !0), e
                ...
                P = 30,
                B = M.getFullYear();
            for (r || (r = "d"), p = S.patterns[r], p && (r = p), r = r.split(""), c = r.length; c > z; z++)
                if (o = r[z], O) "'" === o ? O = !1 : T();
                else if ("d" === o) {
                ...
                if (y("h"), N = x(2), 12 == N && (N = 0), null === N || e(N, 0, 11)) return null
            } else if ("H" === o) {
                if (y("H"), N = x(2), null === N || e(N, 0, 23)) return null
            } else if ("m" === o) {
                if (y("m"), A = x(2), null === A || e(A, 0, 59)) return null
            } else if ("s" === o) {
                ...
                if (h = !0, d = y("z"), "Z" === t.substr(H, 1)) {
                    if (!m) return null;
                    T();
                    continue
                }
                if (g = t.substr(H, 6).match(d > 2 ? l : s), !g) return null;
                if (g = g[0], H = g.length, g = g.split(":"), k = parseInt(g[0], 10), e(k, -12, 13)) return null;
                if (d > 2 && (b = parseInt(g[1], 10), isNaN(b) || e(b, 0, 59))) return null
            } else if ("T" === o) m = T();
            else if ("'" === o) O = !0, T();
            else if (!T()) return null;
            return null === F && (F = B), f && 12 > N && (N += 12), null === E && (E = 1), h ? (k && (N += -k), b && (A += -b), t = new Date(Date.UTC(F, D, E, N, A, I, R))) : (t = new Date(F, D, E, N, A, I, R), i(t, N)), 100 > F && t.setFullYear(F), t
        }
        var a = /\u00A0/g,
            o = /[eE][\-+]?[0-9]+/,
            s = /[+|\-]\d{1,2}/,
        ...
        kendo._adjustDate = i, kendo.parseDate = function (e, t, n) {
            ...
            for (t = isArray(t) ? t : [t], i = t.length; i > o; o++)
                if (s = r(e, t[o], n)) return s;
            return s
    ...
    function () {
        ...
        support.hasHW3D = "WebKitCSSMatrix" in window && "m11" in new window.WebKitCSSMatrix || "MozPerspective" in document.documentElement.style || "msPerspective" in document.documentElement.style, support.hasNativeScrolling = "string" == typeof document.documentElement.style.webkitOverflowScrolling, each(["Moz", "webkit", "O", "ms"], function () {
            ...
            for (var l in r)
                if (r.hasOwnProperty(l) && (i = e.match(r[l]))) {
            ...
            return n
        }, support.mobileOS = support.detectOS(navigator.userAgent), support.kineticScrollNeeded = support.mobileOS && support.touch, support.browser = e(navigator.userAgent),
        function (e) {
            var t, n = "" + e.version,
    ...
    kendo.initWidget = function (e, t, n) {
        ...
        var t, n, i = [];
        for (e[0] || (e = [kendo.ui, kendo.dataviz.ui]), t = 0, n = e.length; n > t; t++) i[t] = e[t].roles;
    ...
    var ContainerNullObject = {
        bind: $.noop
            ...
            container: function () {
                var e = this.element.closest(kendo.roleSelector("view layout"));
    ...
    var MOUSE_EVENTS = ["mousedown", "mousemove", "mouseenter", "mouseleave", "mouseover", "mouseout", "mouseup", "click"],
        EXCLUDE_BUST_CLICK_SELECTOR = "label, input[type=file], [data-rel=external]",
    ...
    extend(kendoJQuery.fn, {
        ...
        on: function () {
            ...
            if (t && (a = a.replace(/( |$)/g, t + " ")), support.touch && a.search(/mouse|click/) > -1 && this[0] !== document.documentElement) {
                MouseEventNormalizer.setupMouseMute();
                var o = 2 === i.length ? null : i[1],
                    s = a.indexOf("click") > -1 && a.indexOf("touchend") > -1;
                on.call(this, {
...
function (e, t) {
    ...
    h.toggleClass = function (e, t, n, i) {
        ...
        return "string" == typeof e ? g(e.split(" "), function (e, i) {
            ...
            i && t && !N.test(e) && (this.direction = Z[i].reverse), n[e] = this
        }), n
    }, y && v(h.fx, {
    ...
    var tt = h.Class.extend({
        ...
        run: function (t) {
            ...
            for (c.effects = t, m.then(e.proxy(c, "complete")), p.data("animating", !0), i = 0; u > i; i++)
                for (n = t[i], n.setReverse(f.reverse), n.setOptions(f), c.addRestoreProperties(n.restore), n.prepare(g, _), l = n.children(), r = 0, d = l.length; d > r; r++) l[r].duration(f.duration).run();
    ...
    u("slideIn", {
        ...
        prepare: function (e, n) {
            var i = this,
                ...
                a = i.options,
                o = i._reverse,
                s = "vertical" === i._direction ? V : W,
                l = r[0].style[s],
                d = r.data(s),
                c = parseFloat(d || l),
                u = M(r.css(s, U)[s]());
            e.overflow = q, c = a && a.reset ? u || c : c || u, n[s] = (o ? 0 : c) + B, e[s] = (o ? c : 0) + B, d === t && r.data(s, l)
        },
        shouldHide: function () {
    ...
    u("turningPage", {
        ...
        prepare: function (e, t) {
            var n = this,
                ...
                a = st[r];
            e.zIndex = 1, n._clipInHalf && (e.clip = f(n._container, h.directions[r].reverse)), e[X] = q, t[Q] = i ? a.start : a.end, e[Q] = i ? a.end : a.start
        },
        setup: function () {
    ...
    var n = window.kendo,
        ...
        c = d.extend({
            ...
            evaluate: function (e, t) {
                for (var n, r, a, o, s, l = t.split("."); n = l.shift();)
                    if (e = e[n], i(e)) {
...
function (e, t) {
    function n(e, t, n, i) {
        return function (r) {
            var a, o = {};
            for (a in r) o[a] = r[a];
            o.field = i ? n + "." + r.field : n, e.trigger(t, o)
        }
    }
    ...
    function r(e, t) {
        var n, i;
        for (i in e) {
            if (n = e[i], z(n) && n.field && n.field === t) return n;
            if (n === t) return n
        }
        return null
    }
    ...
    function s(e) {
        ...
        if (a)
            for (t = 0, n = a.length; n > t; t++) i = a[t], r = i.operator, r && typeof r === q && (i.operator = Ft[r.toLowerCase()] || r), s(i)
    }

    function l(e) {
        return e && !H(e) ? ((O(e) || !e.filters) && (e = {
            logic: "and",
            filters: O(e) ? e : [e]
        }), s(e), e) : t
    }
    ...
    function p(e, t, n, i, r) {
        ...
        for (a = 0; l > a; a++) {
            o = t[a], s = o.aggregate;
            var d = o.field;
            e[d] = e[d] || {}, e[d][s] = Dt[s.toLowerCase()](e[d][s], n, U.accessor(d), i, r)
        }
    }
    ...
    function v(e, t, n) {
        var i, r, a;
        for (r = 0, a = e.length; a > r; r++) i = e[r], i.value = n._parse(i.field, i.value), i.hasSubgroups ? v(i.items, t, n) : g(i.items, t, n)
    }

    function _(e, t, n, i) {
        return function (r) {
            return r = e(r), r && !H(i) && ("[object Array]" === mt.call(r) || r instanceof kt || (r = [r]), n(r, i, new t)), r || []
        }
    }

    function k(e) {
        var t, n, i = [];
        for (t = 0, n = e.length; n > t; t++) i = e[t].hasSubgroups ? i.concat(k(e[t].items)) : i.concat(e[t].items.slice());
        return i
    }
    ...
    function b(e, t) {
        var n, i, r, a;
        if (t)
            for (n = 0, i = e.length; i > n; n++) r = e[n], a = r.items, r.hasSubgroups ? b(a, t) : !a.length || a[0] instanceof t || (a.type = t, a.wrapAll(a, a))
    }
    ...
    var N, A = e.extend,
        ...
        ht = [].unshift,
        mt = {}.toString,
        gt = U.support.stableSort,
        vt = /^\/Date\((.*?)\)\/$/,
        _t = /(?=['\\])/g,
        kt = W.extend({
            init: function (e, t) {
                var n = this;
                n.type = t || bt, W.fn.init.call(n), n.length = e.length, n.wrapAll(e, n)
            },
            toJSON: function () {
                var e, t, n = this.length,
                    i = Array(n);
                for (e = 0; n > e; e++) t = this[e], t instanceof bt && (t = t.toJSON()), i[e] = t;
                return i
            },
            parent: L,
            ...
            wrap: function (e, t) {
                var n, i = this;
                return null !== e && "[object Object]" === mt.call(e) && (n = e instanceof i.type || e instanceof xt, n || (e = e instanceof bt ? e.toJSON() : e, e = new i.type(e)), e.parent = t, e.bind(Q, function (e) {
                    i.trigger(Q, {
                        field: e.field,
                        node: e.node,
                        index: e.index,
            ...
            push: function () {
                ...
                return e = lt.apply(this, n), this.trigger(Q, {
                    action: "add",
                    index: t,
                    items: n
                }), e
            ...
            splice: function (e, t, n) {
                var i, r, a, o = this.wrapAll(ft.call(arguments, 2));
                if (i = ut.apply(this, [e, t].concat(o)), i.length)
                    for (this.trigger(Q, {
                        action: "remove",
                        index: e,
                        items: i
                    }), r = 0, a = i.length; a > r; r++) i[r].children && i[r].unbind(Q);
            ...
            unshift: function () {
                ...
                return e = ht.apply(this, t), this.trigger(Q, {
                    action: "add",
                    index: 0,
                    items: t
                }), e
        ...
        bt = W.extend({
            init: function (e) {
                ...
                W.fn.init.call(this);
                for (n in e) t = e[n], "_" != n.charAt(0) && (i = mt.call(t), t = r.wrap(t, n, a)), r[n] = t;
                r.uid = U.guid()
            },
            shouldSerialize: function (e) {
                return this.hasOwnProperty(e) && "_events" !== e && typeof this[e] !== j && "uid" !== e
            },
            toJSON: function () {
                var e, t, n = {};
                for (t in this) this.shouldSerialize(t) && (e = this[t], (e instanceof bt || e instanceof kt) && (e = e.toJSON()), n[t] = e);
                return n
            },
            get: function (e) {
                var t, n = this;
                return n.trigger(X, {
                    field: e
                }), t = "this" === e ? n : U.getter(e, !0)(n)
            },
            _set: function (e, n) {
                var i = this;
                if (e.indexOf("."))
                    for (var r = e.split("."), a = ""; r.length > 1;) {
                        a += r.shift();
                        var o = U.getter(a, !0)(i);
                        if (o instanceof bt) return o.set(r.join("."), n), t;
                        a += "."
                    }
                U.setter(e)(i, n)
            },
            set: function (e, t) {
                ...
                i !== t && (n.trigger("set", {
                    field: e,
                    value: t
                }) || (n._set(e, n.wrap(t, e, r)), n.trigger(Q, {
                    field: e
                })))
            },
            parent: L,
            wrap: function (e, i, r) {
                var a = this,
                    o = mt.call(e),
                    s = e instanceof kt;
                return null === e || e === t || "[object Object]" !== o || e instanceof Rt || s ? null === e || "[object Array]" !== o && !s ? null !== e && e instanceof Rt && (e._parent = r) : (s || (e = new kt(e)), e.parent() != r() && (e.parent = r, e.bind(Q, n(a, Q, i, !1)))) : (e instanceof bt || (e = new bt(e)), e.parent() != r() && (e.parent = r, e.bind(X, n(a, X, i, !0)), e.bind(Q, n(a, Q, i, !0)))), e
            }
        }),
        wt = {
            number: function (e) {
                return U.parseFloat(e)
            },
            date: function (e) {
                return U.parseDate(e)
            },
            "boolean": function (e) {
            ...
            _parse: function (e, t) {
                var n, i = this,
                    a = e,
                    o = i.fields || {};
                return e = o[e], e || (e = r(o, a)), e && (n = e.parse, !n && e.type && (n = wt[e.type.toLowerCase()])), n ? n(t) : t
            },
            editable: function (e) {
    ...
    xt.define = function (e, n) {
        ...
        for (r in l.fields) a = l.fields[r], o = a.type || "default", s = null, r = typeof a.field === q ? a.field : r, a.nullable || (s = l.defaults[r] = a.defaultValue !== t ? a.defaultValue : yt[o.toLowerCase()]), n.id === r && (l._defaultId = s), l.defaults[r] = s, a.parse = a.parse || wt[o];
        return i = e.extend(l), i.define = function (e) {
            return xt.define(i, e)
    ...
    var St = function () {
        ...
        function t(t, n, i, r) {
            var a;
            return null != i && (typeof i === q && (i = e(i), a = vt.exec(i), a ? i = new Date(+a[1]) : r ? (i = "'" + i.toLowerCase() + "'", n = "(" + n + " || '').toLowerCase()") : i = "'" + i + "'"), i.getTime && (n = "(" + n + "?" + n + ".getTime():" + n + ")", i = i.getTime())), n + " " + t + " " + i
        }
        return {
            eq: function (e, n, i) {
                return t("==", e, n, i)
    ...
    a.filterExpr = function (e) {
        var n, i, r, o, s, l, d = [],
            ...
            p = [],
            f = e.filters;
        for (n = 0, i = f.length; i > n; n++) r = f[n], s = r.field, l = r.operator, r.filters ? (o = a.filterExpr(r), r = o.expression.replace(/__o\[(\d+)\]/g, function (e, t) {
            return t = +t, "__o[" + (p.length + t) + "]"
        }).replace(/__f\[(\d+)\]/g, function (e, t) {
            return t = +t, "__f[" + (u.length + t) + "]"
        }), p.push.apply(p, o.operators), u.push.apply(u, o.fields)) : (typeof s === j ? (o = "__f[" + u.length + "](d)", u.push(s)) : o = U.expr(s), typeof l === j ? (r = "__o[" + p.length + "](" + o + ", " + r.value + ")", p.push(l)) : r = St[(l || "eq").toLowerCase()](o, r.value, r.ignoreCase !== t ? r.ignoreCase : !0)), d.push(r);
        return {
    ...
    a.normalizeFilter = l, a.prototype = {
        toArray: function () {
            return this.data
        },
        range: function (e, t) {
        ...
        orderBy: function (e) {
            var t = this.data.slice(0),
                n = R(e) || !e ? Ct.asc(e) : e.compare;
            return new a(t.sort(n))
        },
        orderByDescending: function (e) {
            return new a(this.data.slice(0).sort(Ct.desc(e)))
        },
        sort: function (e, t, n) {
            var i, r, a = o(e, t),
                s = [];
            if (n = n || Ct, a.length) {
                for (i = 0, r = a.length; r > i; i++) s.push(n.create(a[i]));
                return this.orderBy({
                    compare: n.combine(s)
                })
            }
        ...
        filter: function (e) {
            var t, n, i, r, o, s, d, c, u = this.data,
                p = [];
            if (e = l(e), !e || 0 === e.filters.length) return this;
            for (r = a.filterExpr(e), s = r.fields, d = r.operators, o = c = Function("d, __f, __o", "return " + r.expression), (s.length || d.length) && (c = function (e) {
                return o(e, s, d)
        ...
        groupBy: function (e) {
            if (H(e) || !this.data.length) return new a([]);
            var t, n, i, r, o = e.field,
            ...
            for (i = 0, r = s.length; r > i; i++) t = s[i], n = l.get(t, o), u(d, n) || (d = n, c = {
                field: o,
                value: d,
                items: []
        ...
        _sortForGrouping: function (e, t) {
            ...
            if (!gt) {
                ...
                for (r = new a(r).sort(e, t, Tt).toArray(), n = 0, i = r.length; i > n; n++) delete r[n].__position;
                return r
            }
    ...
    var Dt = {
        ...
        Nt = V.extend({
            init: function (e) {
                var t, n = this;
                e = n.options = A({}, n.options, e), B(it, function (t, n) {
                    typeof e[n] === q && (e[n] = {
                        url: e[n]
                    })
                }), n.cache = e.cache ? At.create(e.cache) : {
                    find: L,
                    add: L
                }, t = e.parameterMap, n.parameterMap = R(t) ? t : function (e) {
                    var n = {};
                    return B(e, function (e, i) {
                        e in t && (e = t[e], z(e) && (i = e.value(i), e = e.key)), n[e] = i
                    }), n
                }
            },
            options: {
            ...
            create: function (e) {
                return P(this.setup(e, $))
            },
            read: function (n) {
                var i, r, a, o = this,
                    s = o.cache;
                n = o.setup(n, G), i = n.success || L, r = n.error || L, a = s.find(n.data), a !== t ? i(a) : (n.success = function (e) {
                    s.add(n.data, e), i(e)
                }, e.ajax(n))
            },
            update: function (e) {
                return P(this.setup(e, Y))
            },
            destroy: function (e) {
                return P(this.setup(e, K))
            },
            setup: function (e, t) {
                e = e || {};
                var n, i = this,
                    r = i.options[t],
                    a = R(r.data) ? r.data(e.data) : r.data;
                return e = A(!0, {}, r, e), n = A(!0, {}, a, e.data), e.data = i.parameterMap(n, t), R(e.url) && (e.url = e.url(n)), e
            }
        }),
        At = V.extend({
            init: function () {
            ...
            add: function (e, n) {
                e !== t && (this._store[ot(e)] = n)
            },
            find: function (e) {
                return this._store[ot(e)]
            },
            clear: function () {
                this._store = {}
            },
            remove: function (e) {
                delete this._store[ot(e)]
            }
        });
    At.create = function (e) {
        ...
        return z(e) && R(e.find) ? e : e === !0 ? new At : t[e]()
    };
    var It = V.extend({
        init: function (e) {
            var t, n, i, r, a = this;
            e = e || {};
            for (t in e) n = e[t], a[t] = typeof n === q ? at(n) : n;
            if (r = e.modelBase || xt, z(a.model) && (a.model = i = r.define(a.model)), a.model) {
                var o = I(a.data, a),
                    s = I(a.groups, a),
                    l = {};
                i = a.model, i.fields && B(i.fields, function (e, t) {
                    z(t) && t.field ? l[t.field] = at(t.field) : l[e] = at(e)
                }), a.data = _(o, i, g, l), a.groups = _(s, i, v, l)
            }
        },
        errors: function (e) {
            return e ? e.errors : null
        ...
        Rt = W.extend({
            init: function (e) {
                var n, i, r, a = this;
                e && (r = e.data), e = a.options = A({}, a.options, e), A(a, {
                    _map: {},
                    _prefetch: {},
                    _data: [],
                    _ranges: [],
                    ...
                    _total: e.total
                }), W.fn.init.call(a), i = e.transport, i ? (i.read = typeof i.read === q ? {
                    url: i.read
                } : i.read, e.type && (U.data.transports[e.type] && !z(U.data.transports[e.type]) ? a.transport = new U.data.transports[e.type](A(i, {
                    data: r
                })) : i = A(!0, {}, U.data.transports[e.type], i), e.schema = A(!0, {}, U.data.schemas[e.type], e.schema)), a.transport || (a.transport = R(i.read) ? i : new Nt(i))) : a.transport = new Et({
                    data: e.data
                }), a.reader = new U.data.readers[e.schema.type || "json"](e.schema), n = a.reader.model || {}, a._data = a._observe(a._data), a.bind([Z, Q, et, J, nt, tt], e)
            },
            options: {
                data: [],
                schema: {
            ...
            _flatData: function (e) {
                return this.options.serverGrouping && this.group().length ? k(e) : e
            },
            get: function (e) {
            ...
            _accept: function (t) {
                ...
                for ("destroy" === d && (i._destroyed = []), o = 0, n = r.length; n > o; o++) "destroy" !== d ? (r[o].accept(a[o]), "create" === d ? l.push(s ? x(i.group(), r[o]) : a[o]) : "update" === d && (s ? i._updatePristineGroupModel(r[o], a[o]) : A(l[i._pristineIndex(r[o])], a[o]))) : s ? i._removePristineGroupModel(r[o]) : l.splice(i._pristineIndex(r[o]), 1)
            },
            _pristineIndex: function (e) {
                var t, n, i = this,
                    r = i.reader.data(i._pristine);
                for (t = 0, n = r.length; n > t; t++)
                    if (r[t][e.idField] === e.id) return t;
                return -1
            },
            _updatePristineGroupModel: function (e, n) {
                var i, r = this.reader.groups(this._pristine);
                w(r, function (r) {
                    return i = C(r, e), i > -1 ? (A(!0, r[i], n), !0) : t
                })
            },
            ...
            _send: function (e, t) {
                ...
                if (r.options.batch) t.length && a.push(r._promise({
                    ...
                    for (n = 0, i = t.length; i > n; n++) a.push(r._promise({
                        data: t[n].toJSON()
                    }, [t[n]], e));
                return a
            },
            ...
            insert: function (e, t) {
                return t || (t = e, e = 0), t instanceof xt || (t = this.reader.model ? new this.reader.model(t) : new bt(t)), this.options.serverGrouping && this.group() && this.group().length ? this._data.splice(e, 0, x(this.group(), t)) : this._data.splice(e, 0, t), t
            },
            cancelChanges: function (e) {
                var t, n, i = this,
                    ...
                    o = a(i._pristine);
                e instanceof U.data.Model ? r ? i._cancelGroupModel(e) : (n = i.indexOf(e), t = i._pristineIndex(e), -1 != n && (-1 == t || e.isNew() ? i._data.splice(n, 1) : i._data[n].accept(o[t]))) : (i._destroyed = [], i._data = i._observe(o), i._change())
            },
            read: function (e) {
                var t = this,
                    n = t._params(e);
                t._queueRequest(n, function () {
                    t.trigger(et) ? t._dequeueRequest() : (t.trigger(tt), t._ranges = [], t.transport.read({
                        data: n,
                        success: I(t.success, t),
                        error: I(t.error, t)
                    }))
                })
            },
            _cancelGroupModel: function (e) {
                ...
                }), i > -1 && w(this._data, function (t) {
                    i = T(t, e), i > -1 && (e.isNew() ? t.splice(i, 1) : A(!0, t[i], n))
                })
            },
            indexOf: function (e) {
            ...
            remove: function (e) {
                var t = this._data;
                return this.options.serverGrouping && this.group() && this.group().length ? this._removeGroupItem(t, e) : y(t, e)
            },
            _removeGroupItem: function (e, n) {
                var i, r = this;
                return w(e, function (e) {
                    return i = y(e, n), i ? (i.isNew && i.isNew() || r._destroyed.push(i), !0) : t
                }), n
            },
            error: function (e, t, n) {
                this._dequeueRequest(), this.trigger(nt, {}), this.trigger(Z, {
                    xhr: e,
                    status: t,
                    errorThrown: n
                })
            ...
            success: function (n) {
                ...
                i._pristine = z(n) ? e.extend(!0, {}, n) : n.slice ? n.slice(0) : n, i._total = i.reader.total(n), i._aggregate && r.serverAggregates && (i._aggregateResult = i.reader.aggregates(n)), n = a ? i.reader.groups(n) : i.reader.data(n), i._data = i._observe(n);
                var o = i._skip || 0,
                    s = o + i._data.length;
                i._ranges.push({
                    start: o,
            ...
            _observe: function (e) {
                var t = this,
                    n = t.reader.model,
                    i = !1;
                return n && e.length && (i = !(e[0] instanceof n)), e instanceof kt ? i && (e.type = t.reader.model, e.wrapAll(e, e)) : (e = new kt(e, t.reader.model), e.parent = function () {
                    return t._parent()
                }), t.group() && t.group().length && t.options.serverGrouping && b(e, n), e.bind(Q, I(t._change, t))
            },
            _change: function (e) {
                var t, n, i = this,
                    r = e ? e.action : "";
                if ("remove" === r)
                    for (t = 0, n = e.items.length; n > t; t++) e.items[t].isNew && e.items[t].isNew() || i._destroyed.push(e.items[t]);
            ...
            query: function (e) {
                ...
                r || i._data === t || 0 === i._data.length ? i.read(i._mergeState(e)) : i.trigger(et) || (i.trigger(tt), n = h(i._data, i._mergeState(e)), i.options.serverFiltering || (i._total = n.total !== t ? n.total : i._data.length), i._view = n.data, i._aggregateResult = m(i._data, e), i.trigger(nt, {}), i.trigger(Q, {
                    items: n.data
                }))
            },
            fetch: function (e) {
                var t = this;
                e && R(e) && t.one(Q, e), t._query()
            },
            _query: function (e) {
                var t = this;
                t.query(A({}, {
            ...
            page: function (e) {
                var n, i = this;
                return e !== t ? (e = st.max(st.min(st.max(e, 1), i.totalPages()), 1), i._query({
                    page: e
                }), t) : (n = i.skip(), n !== t ? st.round((n || 0) / (i.take() || 1)) + 1 : t)
            },
            pageSize: function (e) {
                var n = this;
                return e !== t ? (n._query({
            ...
            range: function (e, n) {
                ...
                if (i = r._findRange(e, st.min(e + n, r.total())), i.length) {
                    ...
                    e > a && r.total() > o && !r._rangeExists(o, st.min(o + n, r.total())) ? r.prefetch(o, n, function () {
                        r.range(e, n)
                    }) : r.range(e, n)
                }))
            },
            _findRange: function (e, n) {
                ...
                for (r = 0, u = f.length; u > r; r++)
                    if (i = f[r], e >= i.start && i.end >= e) {
                        var _ = 0;
                        for (a = r; u > a; a++)
                            if (i = f[a], i.data.length && e + _ >= i.start && (l = i.data, d = i.end, v || (c = h(i.data, {
                                sort: p.sort(),
                                filter: p.filter()
                ...
                i._rangeExists(e, r) ? n && n() : (clearTimeout(i._timeout), i._timeout = setTimeout(function () {
                    i._queueRequest(o, function () {
                        i.transport.read({
                            ...
                            success: function (t) {
                                i._dequeueRequest();
                                for (var r = !1, o = 0, s = i._ranges.length; s > o; o++)
            ...
            _rangeExists: function (e, t) {
                ...
                for (n = 0, i = a.length; i > n; n++)
                    if (e >= a[n].start && a[n].end >= t) return !0;
                return !1
            }
        });
    Rt.create = function (e) {
        ...
        var t, n, i, r = e || {}, a = r.data,
            ...
            l = r.select,
            d = {};
        if (a || !o || r.transport || (s ? a = D(s, o) : l && (a = F(l, o))), U.data.Model && o && (!r.schema || !r.schema.model)) {
        ...
        return r.data = a, r instanceof Rt ? r : new Rt(r)
    };
    var zt = xt.define({
        init: function (e) {
            var t = this,
                ...
                i = "items",
                r = {};
            U.data.Model.fn.init.call(t, e), typeof t.children === q && (i = t.children), r = {
                schema: {
                    data: i,
                    model: {
                        hasChildren: n,
            ...
            }, typeof t.children !== q && A(r, t.children), r.data = e, n || (n = r.schema.data), typeof n === q && (n = U.getter(n)), R(n) && (t.hasChildren = !! n.call(t, t)), t._childrenOptions = r, t.hasChildren && t._initChildren(), t._loaded = !(!e || !e[i])
        },
        _initChildren: function () {
            var e = this;
            e.children instanceof Ht || (e.children = new Ht(e._childrenOptions), e.children._parent = function () {
                return e
            }, e.children.bind(Q, function (t) {
                t.node = t.node || e, e.trigger(Q, t)
        ...
        load: function () {
            var e = this,
                n = {};
            e._initChildren(), (!e._loaded || e.hasChildren) && (n[e.idField || "id"] = e.id, e._loaded || (e.children._data = t), e.children.one(Q, function () {
        ...
        shouldSerialize: function (e) {
            return xt.fn.shouldSerialize.call(this, e) && "children" !== e && "_loaded" !== e && "hasChildren" !== e && "_childrenOptions" !== e
        }
    }),
        Ht = Rt.extend({
            init: function (e) {
            ...
            _find: function (e, t) {
                var n, i, r, a, o;
                if (r = Rt.fn[e].call(this, t)) return r;
                if (a = this._flatData(this.data()))
                    for (n = 0, i = a.length; i > n; n++)
                        if (o = a[n].children, o instanceof Ht && (r = o[e](t))) return r
            },
            get: function (e) {
    ...
    Ht.create = function (e) {
        ...
        var t = e || {}, n = t.data,
            i = t.fields,
            r = t.list;
        return n && n._dataSource ? n._dataSource : (n || !i || t.transport || r && (n = E(r, i)), t.data = n, t instanceof Ht ? t : new Ht(t))
    }, A(!0, U.data, {
        readers: {
            json: It
        },
...
function (e) {
    ...
    function n(e, t, n) {
        var i = n[e];
        return i ? new N(p.initWidget(t, i.options, n)) : void 0
    }

    function i(e) {
        var t, n, r, a, o, s, l, d = {};
        for (l = e.match(A), t = 0, n = l.length; n > t; t++) r = l[t], a = r.indexOf(":"), o = r.substring(0, a), s = r.substring(a + 1), "{" == s.charAt(0) && (s = i(s)), d[o] = s;
        return d
    }
    ...
    function a(e, t, o) {
        ...
        if ((u || f) && s(e), u && (c = n(u, e, o)), f && (f = i(f.replace(I, "")), c || (g = p.parseOptions(e, {
            ...
            template: "",
            valueUpdate: C
        }), g.roles = o, c = new E(e, g)), c.source = t, d = r(f, t, T), g.template && (d.template = new F(t, "", g.template)), d.click && (f.events = f.events || {}, f.events.click = f.click, delete d.click), d.source && (m = !1), f.attr && (d.attr = r(f.attr, t, T)), f.style && (d.style = r(f.style, t, T)), f.events && (d.events = r(f.events, t, S)), c.bind(d)), c && (e.kendoBindingTarget = c), m && h)
            for (l = 0; h.length > l; l++) a(h[l], t, o)
    }
    ...
    function l(e) {
        ...
        if (s(e), i)
            for (t = 0, n = i.length; n > t; t++) l(i[t])
    }
    ...
    v.attr = D.extend({
        ...
        add: function (t, n) {
            var i, r, o, s = this.container(),
                l = s.cloneNode(!1),
                d = s.children[t];
            if (e(l).html(p.render(this.template(), n)), l.children.length)
                for (i = 0, r = n.length; r > i; i++) o = l.children[0], s.insertBefore(o, d || null), a(o, n[i], this.options.roles)
        },
        remove: function (e, t) {
        ...
        render: function () {
            ...
            if (r instanceof m || "[object Array]" === g.call(r) || (r.parent && (i = r.parent), r = new m([r]), r.parent && (r.parent = i)), this.bindings.template) {
                if (e(o).html(this.bindings.template.render(r)), o.children.length)
                    for (t = 0, n = r.length; n > t; t++) a(o.children[t], r[t], this.options.roles)
        ...
        value: D.extend({
            ...
            change: function () {
                ...
                if (l)
                    for (e = this.bindings.source.get(), n = 0; o.length > n; n++)
            ...
            refresh: function () {
                ...
                for (var s = 0; a.length > s; s++)
                    for (r = a[s], o && r instanceof h && (r = r.get(o)), e = 0; i.length > e; e++) t = i[e].value, "" === t && "" !== r && (t = i[e].text), t == r && (i[e].selected = !0)
            },
            destroy: function () {
                e(this.element).off(C, this._change)
            }
        ...
        source: D.extend({
            ...
            _ns: function (t) {
                t = t || p.ui;
                var n = [p.ui, p.dataviz.ui, p.mobile.ui];
                return n.splice(e.inArray(t, n), 1), n.unshift(t), p.rolesFromNamespaces(n)
            },
            dataBound: function (e) {
                var n, i, r = this.widget,
                    ...
                    d = s.group() || [];
                if (o.length)
                    for (d.length && (l = t(l)), n = 0, i = l.length; i > n; n++) a(o[n], l[n], this._ns(e.ns))
            },
            refresh: function (e) {
                var t, n = this,
                    i = n.widget;
            ...
            change: function () {
                ...
                if (i) {
                    ...
                    if (this.bindings.source && (r = this.bindings.source.get()), "" === n && a) n = null;
                        ...
                        for ((!r || r instanceof p.data.DataSource) && (r = this.widget.dataSource.view()), e = 0, t = r.length; t > e; e++)
                            if (r[e].get(i) == n) {
                                n = a ? r[e] : r[e].get(i);
                                break
                            }
    ...
    var E = _.extend({
        ...
        applyBinding: function (e, t, n) {
            var i, r = n[e] || v[e],
                ...
                o = t[e];
            if (r)
                if (r = new r(this.target, t, this.options), a.push(r), o instanceof T) r.bind(o), a.push(o);
                else
                    for (i in o) r.bind(o, i), a.push(o[i]);
        ...
        N = E.extend({
            ...
            applyBinding: function (e, t) {
                ...
                if (i = new i(this.target, t, this.target.options), r.push(i), a instanceof T) i.bind(a), r.push(a);
                    ...
                    for (n in a) i.bind(a, n), r.push(a[n])
            }
        }),
        A = /[A-Za-z0-9_\-]+:(\{([^}]*)\}|[^,}]+)/g,
        I = /\s/g;
...
function (e, t) {
    ...
    var a = window.kendo,
        ...
        b = function (e, t) {
            ...
            var i = e.val();
            return e.filter(t).length && "" !== i ? b(i, n) : !0
        }, y = function (e, n) {
    ...
    var C = o.extend({
        init: function (t, i) {
            var r = this,
                s = n(t);
            i = i || {}, i.rules = e.extend({}, a.ui.validator.rules, s.rules, i.rules), i.messages = e.extend({}, a.ui.validator.messages, s.messages, i.messages), o.fn.init.call(r, t, i), r._errorTemplate = a.template(r.options.errorTemplate), r.element.is(v) && r.element.attr(_, _), r._errors = {}, r._attachEvents()
        },
        options: {
            name: "Validator",
            ...
            rules: {
                required: function (e) {
                    var t = e.filter("[type=checkbox]").length && "checked" !== e.attr("checked"),
                        n = e.val();
                    return !(y(e, "required") && ("" === n || !n || t))
                },
                pattern: function (e) {
                    return e.filter("[type=text],[type=email],[type=url],[type=tel],[type=search],[type=password]").filter("[pattern]").length && "" !== e.val() ? b(e.val(), e.attr("pattern")) : !0
                },
                min: function (e) {
                    if (e.filter(h + ",[" + a.attr("type") + "=number]").filter("[min]").length && "" !== e.val()) {
                ...
                max: function (e) {
                    if (e.filter(h + ",[" + a.attr("type") + "=number]").filter("[max]").length && "" !== e.val()) {
                ...
                step: function (e) {
                    if (e.filter(h + ",[" + a.attr("type") + "=number]").filter("[step]").length && "" !== e.val()) {
                ...
                email: function (e) {
                    return w(e, "[type=email],[" + a.attr("type") + "=email]", c)
                },
                url: function (e) {
                    return w(e, "[type=url],[" + a.attr("type") + "=url]", u)
                },
                date: function (e) {
        ...
        _attachEvents: function () {
            var t = this;
            t.element.is(v) && t.element.on("submit" + s, k(t._submit, t)), t.options.validateOnBlur && (t.element.is(p) ? (t.element.on(m + s, function () {
        ...
        _findMessageContainer: function (e) {
            var t, n = a.ui.validator.messageLocators,
                i = this.element.find("." + l + "[" + a.attr("for") + "=" + e.replace(x, "\\$1") + "]");
...
function (e) {
    ...
    function i(e) {
        ...
        if (e.api) r.push({
            ...
            for (n = o ? o.changedTouches : [], t = n.length; t > s; s++) i = n[s], r.push({
                location: i,
                event: e,
                target: i.target,
                id: i.identifier
    ...
    var r = window.kendo,
        ...
        F = c.extend({
            init: function (n, i) {
                var s, d = this;
                if (i = i || {}, s = d.filter = i.filter, d.threshold = i.threshold || 0, d.touches = [], d._maxTouches = i.multiTouch ? 2 : 1, d.eventNS = r.guid(), n = e(n).handler(d).autoApplyNS(d.eventNS), c.fn.init.call(d), p(d, {
                    element: n,
                    surface: i.global ? l : i.surface || n,
                    stopPropagation: i.stopPropagation,
                    pressed: !1
                }), d.surface.handler(d).autoApplyNS(d.eventNS).on("move", "_move").on("up cancel", "_end"), n.on("down", s, "_start"), o && n.css("-ms-touch-action", "pinch-zoom double-tap-zoom"), i.preventDragEvent && n.on("dragstart", r.preventDefault), i.allowSelection || n.on("mousedown selectstart", s, {
                    root: n
                }, t), a.eventCapture)
            ...
            _start: function (t) {
                var n, r, a = this,
                    ...
                    l = i(t),
                    d = l.length;
                if (!a._maxTouchesReached())
                    for (F.current = null, a.currentTarget = t.currentTarget, a.stopPropagation && t.stopPropagation(); d > o && !a._maxTouchesReached(); o++) r = l[o], n = e(r.target), n = s ? n.is(s) ? n : n.closest(s, a.element) : a.element, n.length && (a.touches.push(new S(a, n, r)), a._isMultiTouch() && a.notify("gesturestart", {}))
            },
            _move: function (e) {
...
function (e, t) {
    ...
    function s(e, n, i) {
        for (var r, a, o = 0, s = n && n.length, l = i && i.length; e && e.parentNode;) {
            ...
            for (o = 0; l > o; o++)
                if (a = i[o], u.matchesSelector.call(e, a.options.filter)) return {
                    target: a,
                    targetElement: e
                };
            e = e.parentNode
    ...
    var W = m.extend({
        ...
        V = h.extend({
            ...
            _drop: function (e) {
                var t = this,
                    n = b[t.options.group];
                n && (n.dropped = !t._trigger(z, e))
            }
        });
    V.destroyGroup = function (e) {
        var t, n = w[e] || y[e];
        if (n) {
            for (t = 0; n.length > t; t++) h.fn.destroy.call(n[t]);
            n.length = 0, delete w[e], delete y[e]
        }
    }, V._cache = w;
    var q = V.extend({
        init: function (e, t) {
        ...
        j = h.extend({
            init: function (e, t) {
                ...
                h.fn.init.call(n, e, t), n.userEvents = new g(n.element, {
                    ...
                    e.keyCode === c.keys.ESC && (n._trigger(A, {
                        event: e
                    }), n.userEvents.cancel())
                }
            },
            ...
            _start: function (t) {
                ...
                if (n.currentTarget = t.target, n.currentTargetOffset = k(n.currentTarget), a) {
                    n.hint = e.isFunction(a) ? e(a.call(n, n.currentTarget)) : a;
            ...
            _end: function (t) {
                ...
                }), n._trigger(N, t), n._cancel(t.event)
            },
            _cancel: function () {
                var e = this;
    ...
    c.ui.plugin(V), c.ui.plugin(q), c.ui.plugin(j), c.TapCapture = H, c.containerBoundaries = o, _(c.ui, {
        Pane: B,
        PaneDimensions: M,
        Movable: W
    })
    ...
    var n = window.kendo,
        ...
        c = i.extend({
            init: function (o, d) {
                ...
                i.fn.init.call(p, o, d), p.draggable = u = p.options.draggable || new n.ui.Draggable(p.element, {
            ...
            destroy: function () {
                var e = this;
                i.fn.destroy.call(e), e.groupContainer.off(a).kendoDropTarget("destroy").kendoDraggable("destroy"), e.options.draggable || e.draggable.destroy(), e.dataSource && e._refreshHandler && e.dataSource.unbind("change", e._refreshHandler)
            },
            options: {
                name: "Groupable",
                filter: "th",
            ...
            descriptors: function () {
                ...
                return t = s.element.find(s.options.filter).map(function () {
                    ...
                    if (r && "" !== r)
                        for (i = r.split(","), r = [], a = 0, o = i.length; o > a; a++) r.push({
                            field: s,
                            aggregate: i[a]
                        });
                    return r
        ...
        f = p.extend({
            ...
            refresh: function () {
                var t, i, o, d, c = this,
                    ...
                    f = c.element,
                    h = f.attr(n.attr(s));
                for (f.removeAttr(n.attr(r)), f.removeAttr(u), t = 0, i = p.length; i > t; t++) o = p[t], h == o.field && f.attr(n.attr(r), o.dir);
                d = f.attr(n.attr(r)), f.find(".k-i-arrow-n,.k-i-arrow-s").remove(), d === a ? (e('<span class="k-icon k-i-arrow-n" />').appendTo(c.link), f.attr(u, "ascending")) : d === l && (e('<span class="k-icon k-i-arrow-s" />').appendTo(c.link), f.attr(u, "descending"))
            },
            _click: function (e) {
                var i, d, c = this,
                    u = c.element,
                    ...
                    h = c.options,
                    m = c.dataSource.sort() || [];
                if (f = f === a ? l : f === l && h.allowUnsort ? t : a, h.mode === o) m = [{
                    field: p,
                    dir: f
                }];
...
function (e) {
    ...
    function n(e, n, i, r) {
        var a, o, s;
        for (a = 0, o = e.length; o > a; a++) s = e.eq(a), t(s, i) ? s.hasClass(l) ? r && n !== s[0] && s.removeClass(l).addClass(f) : s.hasClass(d) || s.hasClass(f) || s.addClass(d) : s.hasClass(d) ? s.removeClass(d) : r && s.hasClass(f) && s.removeClass(f).addClass(l)
    }
    var i = window.kendo,
        r = i.ui.Widget,
        a = e.proxy,
    ...
    var m = r.extend({
        init: function (t, n) {
            var o, s = this;
            r.fn.init.call(s, t, n), s._marquee = e("<div class='k-marquee'></div>"), s._lastActive = null, s.element.addClass(c), o = s.options.multiple, s.userEvents = new i.UserEvents(s.element, {
                global: !0,
                allowSelection: !o,
                filter: (h ? "" : "." + c + " ") + s.options.filter,
                tap: a(s._tap, s)
            }), o && s.userEvents.bind("start", a(s._start, s)).bind("move", a(s._move, s)).bind("end", a(s._end, s))
        },
        events: [u],
        options: {
            name: "Selectable",
        ...
        _tap: function (t) {
            var n, i = e(t.target),
                r = this,
                a = t.event.ctrlKey,
                o = r.options.multiple,
                s = o && t.event.shiftKey;
            i.closest("." + c)[0] === r.element[0] && (n = i.hasClass(l), o && a || r.clear(), s ? r.selectRange(r._firstSelectee(), i) : (n && a ? (r._unselect(i), r._notify(u)) : r.value(i), r._lastActive = r._downTarget = i))
        },
        _start: function (t) {
            var n = this,
                i = e(t.target),
                r = i.hasClass(l),
                a = t.event.ctrlKey;
            return n._downTarget = i, i.closest("." + c)[0] !== n.element[0] ? (n.userEvents.cancel(), n._downTarget = null, undefined) : (n._marquee.appendTo(document.body).css({
                left: t.x.client + 1,
                top: t.y.client + 1,
                width: 0,
                height: 0
            }), a || n.clear(), r && (n._selectElement(i, !0), a && i.addClass(f)), undefined)
        },
        _move: function (e) {
            var t = this,
                i = {
        ...
        selectRange: function (t, n) {
            var i, r, o, s, d = this,
                c = !1,
                p = d.element.find(d.options.filter),
                f = a(d._selectElement, d);
            for (t = e(t)[0], n = e(n)[0], i = 0, r = p.length; r > i; i++) s = p[i], c ? (f(s), c = s !== n) : s === t ? (c = t !== n, f(s)) : s === n ? (o = t, t = n, n = o, c = !0, f(s)) : e(s).removeClass(l);
            d._notify(u)
        },
        destroy: function () {
            var e = this;
    ...
    var d = window.kendo,
        ...
        x = u.extend({
            ...
            options: {
                ...
                refresh: !1,
                messages: {
                    display: _T_("grid.display", "{0} - {1} of {2} items"),
                    empty: _T_("grid.empty", "No items to display"),
                    page: _T_("grid.Page", "Page"),
                    of: _T_("grid.of", "of {0}"),
                    itemsPerPage: _T_("grid.itemsPerPage", "items per page"),
                    first: _T_("grid.first", "Go to the first page"),
                    previous: _T_("grid.previous", "Go to the previous page"),
                    next: _T_("grid.next", "Go to the next page"),
                    last: _T_("grid.last", "Go to the last page"),
                    refresh: _T_("grid.refresh", "Refresh")
                }
            },
            ...
            refresh: function () {
                ...
                f.info && (u = m > 0 ? d.format(f.messages.display, (p - 1) * h + 1, Math.min(p * h, m), m) : f.messages.empty, r.element.find(".k-pager-info").html(u)), f.input && r.element.find(".k-pager-input").html(r.options.messages.page + '<input class="k-textbox">' + d.format(f.messages.of, g)).find("input").val(p).attr(w, 1 > m).toggleClass("k-state-disabled", 1 > m), f.previousNext && (a(r.element, p, g), o(r.element, p, g), s(r.element, p, g), l(r.element, p, g)), f.pageSizes && r.element.find(".k-pager-sizes select").val(h).filter("[" + d.attr("role") + "=dropdownlist]").kendoDropDownList("value", h).kendoDropDownList("text", h)
            },
            _keydown: function (e) {
        ...
        B = r.extend({
            init: function (t, i) {
                ...
                i = i || {}, i.isRtl && (i.origin = i.origin || v + " " + m, i.position = i.position || g + " " + m), r.fn.init.call(o, t, i), t = o.element, i = o.options, o.collisions = i.collision ? i.collision.split(" ") : [], 1 === o.collisions.length && o.collisions.push(o.collisions[0]), a = e(o.options.anchor).closest(".k-popup,.k-group"), i.appendTo = e(e(i.appendTo)[0] || a[0] || b), o.element.hide().addClass("k-popup k-group k-reset").toggleClass("k-rtl", !! i.isRtl).css({
                    ...
                    o._mousedown(e)
                }, o._currentWidth = N.width(), o._resizeProxy = function (e) {
                    o._resize(e)
            ...
            destroy: function () {
                var t, i = this,
                    a = i.options,
                    o = i.element.off(M);
                r.fn.destroy.call(i), a.toggleTarget && e(a.toggleTarget).off(M), I.unbind(E, i._mousedownProxy), A.unbind(R, i._resizeProxy), a.appendTo[0] === document.body && (t = o.parent(".k-animation-container"), t[0] ? t.remove() : o.remove()), n.destroy(i.element.children())
            },
            open: function (t, i) {
                var r, o, s = this,
                    l = {
                ...
                if (!s.visible()) {
                    ...
                    if (I.unbind(E, s._mousedownProxy).bind(E, s._mousedownProxy), a.mobileOS.ios || a.mobileOS.android || A.unbind(R, s._resizeProxy).bind(R, s._resizeProxy), s.wrapper = o = n.wrap(c).css({
                        overflow: k,
                        display: "block",
                        position: _
                    }), a.mobileOS.android && o.add(f).css(H, "translatez(0)"), o.css(y), e(u.appendTo)[0] == document.body && o.css(g, "-10000px"), r = O(!0, {}, u.animation.open), s.flipped = s._position(l), r.effects = n.parseEffects(r.effects, s.flipped), p = r.effects.slideIn ? r.effects.slideIn.direction : p, u.anchor != b) {
                        var h = F + "-" + p;
                ...
                if (a.visible()) {
                    ...
                    a.element.find(".k-popup").each(function () {
                        var t = e(this),
                            n = t.data("kendoPopup");
                        n && n.close()
                    }), I.unbind(E, a._mousedownProxy), A.unbind(R, a._resizeProxy), t = O(!0, {}, o.animation.close), i = a.element.data(T), r = t.effects, a.wrapper = n.wrap(a.element).css({
                        overflow: k
            ...
            _position: function (t) {
                var n, i, r, s, l = this,
                    ...
                    f = e(p).offset(),
                    h = e(u.anchor),
                    m = u.origin.toLowerCase().split(" "),
                    g = u.position.toLowerCase().split(" "),
                    v = l.collisions,
                    k = a.zoomLevel(),
                    b = 10002,
                    x = 0;
                if (n = h.parents().filter(c.siblings()), n[0])
                    if (r = Number(e(n).css("zIndex"))) b = r + 1;
                    else
                        for (i = h.parentsUntil(n), s = i.length; s > x; x++) r = Number(e(i[x]).css("zIndex")), r && r > b && (b = r + 1);
                c.css("zIndex", b), t && t.isFixed ? c.css({
                    left: t.x,
                    top: t.y
                }) : c.css(l._align(m, g));
                var T = o(c, y),
                    S = o(c),
                    F = h.offsetParent().parent(".k-animation-container");
                F.length && F.data(C) && (T = o(c, y), S = o(c)), p[0] === window ? (S.top -= window.pageYOffset || document.documentElement.scrollTop || 0, S.left -= window.pageXOffset || document.documentElement.scrollLeft || 0) : (S.top -= f.top, S.left -= f.left), l.wrapper.data(w) || c.data(w, O({}, T));
                var D = O({}, S),
                    E = O({}, T);
                "fit" === v[0] && (E.top += l._fit(D.top, c.outerHeight(), p.height() / k)), "fit" === v[1] && (E.left += l._fit(D.left, c.outerWidth(), p.width() / k)), E.left != T.left || E.top != T.top ? c.data(C, !0) : c.removeData(C);
                var N = O({}, E);
                return "flip" === v[0] && (E.top += l._flip(D.top, d.outerHeight(), h.outerHeight(), p.height() / k, m[0], g[0], c.outerHeight())), "flip" === v[1] && (E.left += l._flip(D.left, d.outerWidth(), h.outerWidth(), p.width() / k, m[1], g[1], c.outerWidth())), d.css(y, _), c.css(E), E.left != N.left || E.top != N.top
            },
            _align: function (t, n) {
                var i, r = this,
                    a = r.wrapper,
...
function (e, t) {
    ...
    var i = window.kendo,
        ...
        y = e.proxy,
        x = i.support.browser,
        C = x.msie && 9 > parseInt(x.version, 10),
        T = /"/g,
        S = a.extend({
            init: function (t, n) {
                var r, o = this,
                ...
                }).on("touchend" + s + " click" + s, d, y(o._click, o)).attr({
                    tabIndex: -1,
                    role: "listbox",
                    "aria-hidden": !0
            ...
            _adjustListWidth: function () {
                var e, t, n = this.list,
                    i = n[0].style.width,
                    r = this.wrapper;
                if (n.data(b) || !i) return e = window.getComputedStyle ? window.getComputedStyle(r[0], null) : 0, t = e ? parseFloat(e.width) : r.outerWidth(), e && (x.mozilla || x.msie) && (t += parseFloat(e.paddingLeft) + parseFloat(e.paddingRight) + parseFloat(e.borderLeftWidth) + parseFloat(e.borderRightWidth)), i = t - (n.outerWidth() - n.width()), n.css({
            ...
            _popup: function () {
                var e = this,
                    ...
                    a = e.options,
                    o = e.wrapper;
                e.popup = new r.Popup(t, w({}, a.popup, {
                    anchor: o,
                    open: function (t) {
            ...
            _unbindDataSource: function () {
                var e = this;
                e.dataSource.unbind(c, e._refreshHandler).unbind(_, e._progressHandler).unbind(k, e._requestEndHandler)
            }
        });
    w(S, {
        caret: function (e) {
        ...
        _dataSource: function () {
            ...
            }]), n.dataSource && n._refreshHandler ? n._unbindDataSource() : (n._refreshHandler = y(n.refresh, n), n._progressHandler = y(n._showBusy, n), n._requestEndHandler = y(n._requestEnd, n)), n.dataSource = i.data.DataSource.create(o).bind(c, n._refreshHandler).bind(_, n._progressHandler).bind(k, n._requestEndHandler)
        },
        _index: function (e) {
            var n, i, r, a = this,
                o = a._data();
            for (n = 0, i = o.length; i > n; n++)
                if (r = a._value(o[n]), r === t && (r = a._text(o[n])), r == e) return n;
            return -1
        },
        _get: function (t) {
            var n, i, r = this,
        ...
        _options: function (e, n) {
            var i, r, a, o, l = this,
                ...
                p = "",
                f = 0;
            for (n && (p = n, f = 1); u > f; f++) i = "<option", r = e[f], a = l._text(r), o = l._value(r), o !== t && (o += "", -1 !== o.indexOf('"') && (o = o.replace(T, "&quot;")), i += ' value="' + o + '"'), i += ">", a !== t && (i += s(a)), i += "</option>", p += i;
        ...
        _cascade: function () {
            var t, i, r, a, o = this,
                ...
                l = s.cascadeFrom;
            if (l) {
                if (t = e("#" + l).data("kendo" + s.name), !t) return;
                r = t.options.dataValueField, a = function () {
                    var e = o._selectedValue || o.value();
                    e ? (o.value(e), o.dataSource.view()[0] && -1 !== o.selectedIndex || o._clearSelection(t, !0)) : o.select(s.index), o.enable()
                }, i = function () {
                    var e, i, s = t.dataItem(),
                        l = s ? t._value(s) : null;
                    l ? (e = o.dataSource.filter() || {}, n(e, r), i = e.filters || [], i.push({
                        field: r,
                        operator: "eq",
                        value: l
                    }), o.dataSource.one(c, a).filter(i)) : (o.enable(!1), o._clearSelection(t)), o._triggerCascade()
                }, t.bind("cascade", function () {
                    i()
                }), t._bound ? i() : t.value() || o.enable(!1)
            }
        }
...
function (e, t) {
    ...
    var m = window.kendo,
        ...
        Z = "touchstart" + N + " mouseenter" + N,
        et = "touchend" + N + " mouseleave" + N,
        tt = 6e4,
        nt = 864e5,
        it = "_prevArrow",
        rt = "_nextArrow",
        ...
        ct = {
            ...
            init: function (t, n) {
                var i, a, o = this;
                v.fn.init.call(o, t, n), t = o.wrapper = o.element, n = o.options, n.url = window.unescape(n.url), o._templates(), o._header(), o._footer(o.footer), a = t.addClass("k-widget k-calendar").on(Z + " " + et, Y, l).on(I, "table.k-content", st(o._move, o)).on(A, Y, function (t) {
            ...
            destroy: function () {
                var e = this,
                    t = e._today.off(N);
                e.element.off(N), e._title.off(N), e[it].off(N), e[rt].off(N), m.destroy(t), m.destroy(e._view), v.fn.destroy.call(e)
            },
            focus: function (e) {
                e = e || this._table, this._bindTable(e), e.focus()
            },
            min: function (e) {
                return this._option(z, e)
            },
            max: function (e) {
            ...
            navigateUp: function () {
                var e = this,
                    t = e._index;
                e._title.hasClass(V) || e.navigate(e._current, ++t)
            },
            ...
            navigate: function (n, i) {
                ...
                var a, o, s, l, d = this,
                    ...
                    k = n && +n > +_,
                    b = i !== t && i !== d._index;
                n ? d._current = n = new dt(+r(n, f, h)) : n = _, i === t ? i = d._index : d._index = i, d._view = o = pt.views[i], s = o.compare, l = i === ct[P], m.toggleClass(V, l).attr(at, l), l = 1 > s(n, f), d[it].toggleClass(V, l).attr(at, l), l = s(n, h) > -1, d[rt].toggleClass(V, l).attr(at, l), (!g || d._changeView) && (m.html(o.title(n, u)), d._table = a = e(o.content(lt({
                    min: f,
                    max: h,
                    date: n,
                    url: c.url,
                    ...
                    vertical: b,
                    future: k
                }), d._focus(n), d.trigger(L)), i === ct[c.depth] && v && d._class("k-state-selected", o.toDateString(v)), d._class(q, o.toDateString(n)), !g && d._cell && d._cell.removeClass(q), d._changeView = !0
            },
            value: function (e) {
                var n = this,
                    i = n._view,
            ...
            _horizontal: function (e, t, n) {
                var i = this,
                    r = i._active,
                    a = i.options.animation.horizontal,
                    o = a.effects,
                    s = e.outerWidth();
                o && -1 != o.indexOf(O) && (e.add(t).css({
                    width: s
                    ...
                    "float": H,
                    left: n ? 0 : -s
                }), t[n ? "insertAfter" : "insertBefore"](e), lt(a, {
                    effects: O + ":" + (n ? "right" : H),
                    complete: function () {
                        e.remove(), t.unwrap(), i._focusView(r)
                    }
            ...
            _class: function (t, n) {
                ...
                }).attr(ot, !0), t !== q || i._active || i.options.focusOnNav === !1 || (t = ""), a.addClass(t), a[0] && (i._cell = a), r && (a.attr(R, r), i._table.removeAttr("aria-activedescendant").attr("aria-activedescendant", r))
            },
            ...
            _click: function (e) {
                ...
                a = new dt(a[0], a[1], a[2]), k(a), t._view.setDate(i, a), t.navigateDown(r(i, n.min, n.max))
            },
            _focus: function (e) {
                var t = this,
                    n = t._view;
            ...
            _header: function () {
                ...
                n.find(".k-header")[0] || n.html('<div class="k-header"><a href="#" role="button" class="k-link k-nav-prev"><span class="k-icon k-i-arrow-w"></span></a><a href="#" role="button" aria-live="assertive" aria-atomic="true" class="k-link k-nav-fast"></a><a href="#" role="button" class="k-link k-nav-next"><span class="k-icon k-i-arrow-e"></span></a></div>'), e = n.find(".k-link").on(Z + " " + et + " " + J + " " + K, l).click(!1), t._title = e.eq(1).on(A, function () {
                    t._focusView(i), t.navigateUp()
                }), t[it] = e.eq(0).on(A, function () {
                    t._focusView(i), t.navigateToPast()
                }), t[rt] = e.eq(2).on(A, function () {
            ...
            _navigate: function (e, t) {
                var n = this,
                    i = n._index + 1,
                    r = new dt(+n._current);
                e = n[e], e.hasClass(V) || (i > 3 ? r.setFullYear(r.getFullYear() + 100 * t) : pt.views[i].setDate(r, t), n.navigate(r))
            },
            _option: function (e, n) {
                var i, r, a = this,
                    ...
                    s = +a._value,
                    l = rt;
                return n === t ? o[e] : (n = _(n, o.format, o.culture), n && (o[e] = new dt(+n), r = a._view.compare(n, a._current), e === z ? (i = +n > s, r = r > -1, l = it) : (i = s > +n, r = 1 > r), i ? a.value(null) : r ? a.navigate() : a[l].toggleClass(V, !1).attr(at, !1), a._toggle()), t)
            },
            _toggle: function (e) {
                var n = this,
                    i = n.options,
                    r = n._today;
                e === t && (e = a(new dt, i.min, i.max)), r && (r.off(A), e ? r.addClass(G).removeClass(V).on(A, st(n._todayClick, n)) : r.removeClass(G).addClass(V).on(A, d))
            },
...
function (e, t) {
    function n(t) {
        ...
        z.normalize(t), n = e.isArray(n) ? n : [n], n.splice(0, 0, t.format), t.parseFormats = n
    }
    ...
    var r = window.kendo,
        ...
        U = function (t) {
            ...
            s || (s = W.sharedCalendar = new a.Calendar(e(c).attr(F, r.guid()).hide().appendTo(o), {
                focusOnNav: !1
            }), z.makeUnselectable(s.element)), i.calendar = s, i.options = t = t || {}, n = t.id, n && (n += "_dateview", l.attr(F, n), i._dateViewID = n), i.popup = new a.Popup(l, P(t.popup, t, {
                name: "Popup",
    ...
    U.prototype = {
        ...
        destroy: function () {
            var n, i = this,
                ...
                a = r.element,
                o = a.data(v);
            (o === t || o === i) && (n = e(".k-calendar-container"), n.length > 1 ? a.hide().appendTo(document.body) : (a.off(p), r.destroy(), W.sharedCalendar = null)), i.popup.destroy()
        },
        open: function () {
            var e = this;
    ...
    var W = o.extend({
        ...
        enable: function (e) {
            var t = this,
                ...
                a = t.element;
            e === !1 ? (r.removeClass(k).addClass(y), a.attr(_, _).attr(A, !0)) : (r.addClass(k).removeClass(y).on(T, t._toggleHover), a.removeAttr(_).attr(A, !1), n.on(f, B(t._click, t)).on(S, i))
        },
        destroy: function () {
            var e = this;
        ...
        _update: function (e) {
            ...
            return +l === +n._value ? (t = r.toString(l, i.format, i.culture), t !== e && n.element.val(null === l ? e : t), l) : (null !== l && M(l, a) ? l = O(l, a, o) : H(l, a, o) || (l = null), n._value = l, n.dateView.value(l), n.element.val(l ? r.toString(l, i.format, i.culture) : e), n._updateARIA(l), l)
        },
        _wrapper: function () {
            var t, n = this,
                i = n.element;
        ...
        v = a.extend({
            ...
            _select: function (e) {
                var n, i, a, o = this,
                    s = o._current,
                    l = o._data();
                e = o._get(e), e && e[0] && !e.hasClass(h) && (s && s.removeClass(h), a = r.List.inArray(e[0], o.ul[0]), a > -1 && (l = l[a], i = o._text(l), n = o._value(l), o.selectedIndex = a, o.text(i), o._accessor(n !== t ? n : i, a), o._selectedValue = o._accessor(), o.current(e.addClass(h)), o._optionID && o._current.attr("aria-selected", !0)))
            },
            _mobile: function () {
                var e = this,
                    t = e.popup,
        ...
        F = a.extend({
            init: function (t, i) {
                ...
                s.ns = c, i = e.isArray(i) ? {
                    ...
                    role: "combobox",
                    "aria-expanded": !1
                }), s._aria(), s._oldIndex = s.selectedIndex = -1, s._old = i.value || s._accessor(), i.autoBind ? s._filterSource() : (o = i.text, !o && t.is(_) && (o = t.children(":selected").text()), o && s.input.val(o)), o || s._placeholder(), n.notify(s)
            },
            options: {
                name: "ComboBox",
                enable: !0,
            ...
            text: function (e) {
                ...
                }), 0 > i.selectedIndex && (i._custom(e), a.value = e), i._triggerCascade()), t)
            },
            toggle: function (e) {
                var t = this;
                t._toggle(e)
            ...
            value: function (e) {
                var n, i = this;
                return e === t ? i._accessor() : (null !== e && (e = "" + e), i._selectedValue = e, !i._open && e && i._fetchItems(e) || (n = i._index(e), n > -1 ? i.select(n) : (i.current(T), i._custom(e), i.text(e), i._placeholder()), i._old = i._accessor(), i._oldIndex = i.selectedIndex), t)
            },
            _accept: function (e) {
                var t = this;
            ...
            _custom: function (t) {
                var n = this,
                    i = n.element,
                    r = n._option;
                n._state === w && (n._state = y), i.is(_) ? (r || (r = n._option = e("<option/>"), i.append(r)), r.text(t), r[0].selected = !0) : i.val(t), n._selectedValue = t
            },
            _filter: function (e) {
                var n = this,
                    i = n.options,
            ...
            _select: function (e) {
                var n, i, r = this,
                    a = r._data(),
                    o = r._highlight(e);
                r.selectedIndex = o, -1 !== o && (r._state === w && (r._state = y), r._current.addClass(b), a = a[o], n = r._text(a), i = r._value(a), r._prev = r.input[0].value = n, r._accessor(i !== t ? i : n, o), r._selectedValue = r._accessor(), r._placeholder(), r._optionID && r._current.attr("aria-selected", !0))
            },
...
function (e, t) {
    ...
    function o(e) {
        var t, n, i = {}, r = {};
        if (!N(e))
            for (S(e) || (e = [e]), t = 0, n = e.length; n > t; t++) i[e[t].aggregate] = 0, r[e[t].field] = i;
        return r
    }
    ...
    function f(e, t) {
        ...
        if (S(e))
            for (n = 0, i = e.length; i > n; n++)
                if (r = e[n], typeof r === at && r === t || r.name === t) return r;
        return null
    }
    ...
    var m = window.kendo,
        ...
        I = "progress",
        R = "error",
        z = ":not(.k-group-cell):not(.k-hierarchy-cell):visible",
        H = "tbody>tr:not(.k-grouping-row):not(.k-detail-row):not(.k-group-footer) > td:not(.k-group-cell):not(.k-hierarchy-cell)",
        ...
        pt = b.extend({
            ...
            setDataSource: function (e) {
                var t = this;
                t.dataSource && t.dataSource.unbind(q, t._refreshHandler), t.dataSource = e, t.dataSource.bind(q, t._refreshHandler)
            },
            options: {
            ...
            destroy: function () {
                var e = this;
                b.fn.destroy.call(e), e.dataSource.unbind(q, e._refreshHandler), e.wrapper.add(e.verticalScrollbar).off(B), e.drag && e.drag.destroy()
            },
            wrap: function () {
                var t, n = this,
            ...
            _scroll: function (e) {
                var t = this,
                    ...
                    d = A.max(A.floor(n / r), 0),
                    c = A.max(d + A.floor(s / r), 0);
            ...
            _fetch: function (e, t, n) {
                var i = this,
                    ...
                    d = !1,
                    c = .33;
                return s > e ? (d = !0, s = A.max(0, t - o), i._scrollTop = (e - s) * a, i._page(s, o)) : t >= s + o && !n ? (d = !0, s = e, i._scrollTop = a, i._page(s, o)) : i._fetching || (l + o - o * c > e && e > o && r.prefetch(l - o, o), t > l + o * c && r.prefetch(l + o, o)), d
            },
            _page: function (e, t) {
                var n = this,
                    i = n.dataSource;
            ...
            refresh: function () {
                ...
                for (e = o.total() * n + c, t = 0; A.floor(e / a) > t; t++) r += '<div style="width:1px;height:' + a + 'px"></div>';
        ...
        ft = {
            ...
            events: [q, "dataBinding", Y, K, Q, V, L, U, W, G, Z, et, $, j],
            setDataSource: function (e) {
                var t = this;
            ...
            reorderColumn: function (e, t) {
                ...
                if (o !== e)
                    for (a.columns.splice(o, 1), a.columns.splice(e, 0, t), a._templates(), s(a.thead.prev().find("col:not(.k-group-col,.k-hierarchy-col)"), l, e), a.options.scrollable && s(a.tbody.prev().find("col:not(.k-group-col,.k-hierarchy-col)"), l, e), s(a.thead.find(".k-header:not(.k-group-cell,.k-hierarchy-cell)"), o, e), c && c.length && (s(c.find(".k-grid-footer-wrap>table>colgroup>col:not(.k-group-col,.k-hierarchy-col)"), l, e), s(c.find(".k-footer-template>td:not(.k-group-cell,.k-hierarchy-cell)"), o, e)), n = a.tbody.children(":not(.k-grouping-row,.k-detail-row)"), i = 0, r = n.length; r > i; i += 1) s(n.eq(i).find(">td:not(.k-group-cell,.k-hierarchy-cell)"), o, e)
            },
            ...
            _detachModelChange: function () {
                ...
                n && n.unbind(q, e._modelChangeHandler)
            },
            closeCell: function () {
                var t = this,
            ...
            editRow: function (n) {
                ...
                r.cancelRow(), a && (r._attachModelChange(a), "popup" === o ? r._createPopupEditor(a) : "inline" === o ? r._createInlineEditor(n, a) : "incell" === o && e(n).children(z).each(function () {
                    var n = e(this),
                        i = r.columns[n.index()];
            ...
            _createPopupEditor: function (t) {
                ...
                if (g)
                    for (typeof g === at && (g = window.unescape(g)), u += m.template(g, _)(t), r = 0, a = c.columns.length; a > r; r++) n = c.columns[r], n.command && (i = f(n.command, "edit"));
                else
                    for (r = 0, a = c.columns.length; a > r; r++)
                        if (n = c.columns[r], n.command) n.command && (i = f(n.command, "edit"));
            ...
            addRow: function () {
                ...
                if (t.editable && t.editable.end() || !t.editable) {
                    ...
                    var s = n.insert(e, {}),
                        ...
                        c = d.children("td:not(.k-group-cell,.k-hierarchy-cell)").eq(t._firstEditableColumnIndex(d));
            ...
            _firstEditableColumnIndex: function (e) {
                var t, n, i, r = this,
                    a = r.columns,
                    o = r._modelForContainer(e);
                for (n = 0, i = a.length; i > n; n++)
                    if (t = a[n], o && (!o.editable || o.editable(t.field)) && !t.command && t.field) return n;
                return -1
            },
            _toolbar: function () {
                var t, n = this,
                    i = n.wrapper,
                    r = n.options.toolbar,
                    a = n.options.editable;
                r && (t = n.wrapper.find(".k-grid-toolbar"), t.length || (E(r) || (r = typeof r === at ? r : n._toolbarTmpl(r).replace(dt, "\\#"), r = D(m.template(r), n)), t = e('<div class="k-toolbar k-grid-toolbar" />').html(r({})).prependTo(i)), a && a.create !== !1 && t.on("touchend" + B + " " + tt + B, ".k-grid-add", function (e) {
            ...
            _selectable: function () {
                ...
                r && (e = typeof r === at && r.toLowerCase().indexOf("multiple") > -1, n = typeof r === at && r.toLowerCase().indexOf("cell") > -1, i.selectable = new m.ui.Selectable(i.table, {
                    filter: ">" + (n ? H : "tbody>tr:not(.k-grouping-row,.k-detail-row,.k-group-footer)"),
                    aria: !0,
                    multiple: e,
                    change: function () {
                        i.trigger(q)
                    }
                }), i.options.navigatable && i.table.on("keydown" + B, function (r) {
                    var a = i.current();
                    if (r.keyCode === w.SPACEBAR && r.target == i.table[0] && !a.is(".k-edit-cell,.k-header") && a.parent().is(":not(.k-grouping-row,.k-detail-row,.k-group-footer)")) {
                        if (r.preventDefault(), r.stopPropagation(), a = n ? a : a.parent(), e)
                            if (r.ctrlKey) {
                                if (a.hasClass(X)) return a.removeClass(X), i.trigger(q), t
                            } else i.selectable.clear();
                            else i.selectable.clear();
                        i.selectable.value(a)
                    }
                }))
            },
            clearSelection: function () {
                var e = this;
                e.selectable.clear(), e.trigger(q)
            },
            select: function (n) {
                var i = this,
                    r = i.selectable;
            ...
            _navigatable: function () {
                ...
                t.options.navigatable && (t.options.scrollable && (a = i.add(r), r.attr(it, -1)), r.on("keydown" + B, function (e) {
                ...
                }).find("a.k-link").attr("tabIndex", -1), i.attr(it, A.max(i.attr(it) || 0, 0)).on("mousedown" + B + " keydown" + B, ".k-detail-cell", function (e) {
                    ...
                    else if (c && l == w.LEFT) n(v ? v.prevAll(z + ":first") : i.find(P)), d = !0;
                    else if (c && l == w.RIGHT) v ? v.next()[0] && (v = v.nextAll(z + ":first")) : v = i.find(P), d = !0, n(v);
                    else if (c && u && w.PAGEDOWN == l) p.page(p.page() + 1), d = !0;
                    else if (c && u && w.PAGEUP == l) p.page(p.page() - 1), d = !0;
                    else if (l == w.ENTER || w.F2 == l)
                        if (v = v ? v : i.find(P), v.is("th")) v.find(".k-link").click(), d = !0;
            ...
            _handleEditing: function (n, i) {
                ...
                if (a = "incell" == l ? n.hasClass("k-edit-cell") : n.parent().hasClass("k-grid-edit-row"), o.editable) {
                    ...
                    if (!o.editable.end()) return "incell" == l ? o.current(d) : o.current(d.children().filter(z).first()), r = d.find(":focusable:first")[0], r && r.focus(), t;
            ...
            _footer: function () {
                ...
                if (r)
                    if (n = N(n) ? o(t.dataSource.aggregate()) : n, i = e(t._wrapFooter(r(n))), s.length) {
                        var l = i;
            ...
            _templates: function () {
                var t = this,
                    ...
                    o = i.aggregate();
                t.rowTemplate = t._tmpl(n.rowTemplate), t.altRowTemplate = t._tmpl(n.altRowTemplate || n.rowTemplate, !0), t._hasDetails() && (t.detailTemplate = t._detailTmpl(n.detailTemplate || "")), (!N(o) && !a.length || T(t.columns, function (e) {
            ...
            _hasDetails: function () {
                var e = this;
                return null !== e.options.detailTemplate || (e._events[V] || []).length
            },
            _details: function () {
                var t = this;
                t.table.on("touchend" + B + " " + tt + B, ".k-hierarchy-cell .k-plus, .k-hierarchy-cell .k-minus", function (n) {
                    var i, r, a = e(this),
                        ...
                        l = t.detailTemplate,
                        d = t._hasDetails();
                    return a.toggleClass("k-plus", !o).toggleClass("k-minus", o), d && !s.next().hasClass("k-detail-row") && (r = t.dataItem(s), e(l(r)).addClass(s.hasClass("k-alt") ? "k-alt" : "").insertAfter(s), t.trigger(V, {
                        masterRow: s,
                        detailRow: s.next(),
                        data: r,
            ...
            _groupRowHtml: function (e, t, i) {
                ...
                if (u && (p = typeof u === rt ? u(f) : m.template(u)(f)), s += '<tr class="k-grouping-row">' + n(i) + '<td colspan="' + t + '" aria-expanded="true">' + '<p class="k-reset">' + '<a class="k-icon k-i-collapse" href="#" tabindex="-1"></a>' + p + "</p></td></tr>", e.hasSubgroups)
                    for (r = 0, a = g.length; a > r; r++) s += o._groupRowHtml(g[r], t - 1, i + 1);
            ...
            refresh: function (t) {
                ...
                if (!(t && "itemchange" === t.action && l.editable || (t = t || {}, l.trigger("dataBinding", {
                    ...
                    if (p && (l.table[0] === document.activeElement || e.contains(l.table[0], document.activeElement)) && (h = f.is("th"), s = 0, h && (s = l.thead.find("th:not(.k-group-cell)").index(f))), l._destroyEditable(), l._progress(!1), l._data = [], l.columns.length || (l._autoColumns(l._firstDataItem(u[0], m)), g = m + l.columns.length), l._group = m > 0 || l._group, l._group && (l._templates(), l._updateCols(), l._updateHeader(m), l._group = m > 0), m > 0)
                        for (l.detailTemplate && g++, l.groupFooterTemplate && (l._groupAggregatesDefaultObject = o(l.dataSource.aggregate())), i = 0, n = u.length; n > i; i++) c += l._groupRowHtml(u[i], g, 0);
                    else c += l._rowsHtml(u);
                    k ? l.tbody[0].innerHTML = c : (a = document.createElement("div"), a.innerHTML = "<table><tbody>" + c + "</tbody></table>", r = a.firstChild.firstChild, l.table[0].replaceChild(r, l.tbody[0]), l.tbody = e(r)), l._footer(), l._setContentHeight(), s >= 0 && (l._removeCurrent(), h ? l.current(l.thead.find("th:not(.k-group-cell)").eq(s)) : l.current(l.items().eq(s).children().filter(z).first()), l._current.closest("table")[0].focus()), l.trigger(Y)
                }
            }
        });
...
function (e, t) {
    var n = window.kendo,
        ...
        x = o.extend({
            ...
            _dataSource: function () {
                var e = this;
                e.dataSource && e._refreshHandler ? e._unbindDataSource() : (e._refreshHandler = b(e.refresh, e), e._progressHandler = b(e._progress, e), e._errorHandler = b(e._error, e)), e.dataSource = y.create(e.options.dataSource).bind(i, e._refreshHandler).bind(d, e._progressHandler).bind(c, e._errorHandler)
            },
            _progress: function () {
                w(this.element, !0)
            },
            ...
            _selectable: function () {
                ...
                o && (e = typeof o === h && o.toLowerCase().indexOf("multiple") > -1, e && a.element.attr("aria-multiselectable", !0), a.selectable = new n.ui.Selectable(a.element, {
                    ...
                    if (n.keyCode === s.SPACEBAR) {
                        if (r = a.current(), n.target == n.currentTarget && n.preventDefault(), e)
                            if (n.ctrlKey) {
            ...
            current: function (e) {
                var n = this,
                    ...
                    r = n._current,
                    a = n._itemId;
                return e === t ? r : (r && (r[0].id === a && r.removeAttr("id"), r.removeClass(u), i.removeAttr("aria-activedescendant")), e && e[0] && (a = e[0].id || a, n._scrollTo(e[0]), i.attr("aria-activedescendant", a), e.addClass(u).attr("id", a)), n._current = e, t)
            },
            ...
            _navigatable: function () {
                ...
                i && (t._tabindex(), r.on("focus" + k, function () {
                    ...
                    var a, o = i.keyCode,
                        ...
                        p = n.preventDefault,
                        h = r.find("." + f);
                    if (!(!c && !u && s.ESC != o || u && s.ESC != o && s.ENTER != o))
                        if (s.UP === o || s.LEFT === o) l && (l = l.prev()), t.current(l && l[0] ? l : t._item("last")), p(i);
            ...
            _closeEditable: function (t) {
                var i, r, a = this,
                    ...
                    s = a.template,
                    l = !0;
                return o && (t && (l = o.end()), l && (o.element.index() % 2 && (s = a.altTemplate), i = a._modelFromElement(o.element), r = e(s(i)).attr(n.attr("uid"), i.uid), a._destroyEditable(), o.element.replaceWith(r))), l
            },
            edit: function (t) {
                var i = this,
            ...
            save: function () {
                var e, t = this,
                    n = t.editable;
                n && (n = n.element, e = t._modelFromElement(n), !t.trigger(v, {
                    model: e,
                    item: n
...
function (e, t) {
    ...
    var E = s.extend({
        ...
        _findFile: function (e) {
            ...
            for (e = e.toLowerCase(), t = 0, i = r.length; i > t; t++)
                if ("f" === r[t].get(a) && r[t].get(o).toLowerCase() === e) {
                    n = r[t];
                    break
                }
            return n
        ...
        _nameExists: function (e, t) {
            var n, i, r = this.dataSource.data(),
                ...
                o = this._getFieldName(w);
            for (n = 0, i = r.length; i > n; n++)
                if ("d" === r[n].get(a) && r[n].get(o).toLowerCase() === e.toLowerCase() && r[n].uid !== t) return !0;
            return !1
        },
        _nameDirectory: function () {
            ...
            if (e.inArray(r, o) > -1) {
                n = 2;
                do t = r + " (" + n + ")", n++; while (e.inArray(t, o) > -1);
                r = t
            }
            return r
        },
    ...
    o.ui.plugin(E), o.ui.plugin(A), o.ui.plugin(N)
}(window.kendo.jQuery),
function (e, t) {
    var n = window.kendo,
        i = n.Class,
        ...
        p = {
            ...
            renderTools: function (t, i) {
                ...
                if (i)
                    for (o = 0; i.length > o; o++) r = i[o], d = null, e.isPlainObject(r) ? r.name && t.tools[r.name] ? (e.extend(t.tools[r.name].options, r), c[r.name] = t.tools[r.name], d = c[r.name].options) : (d = s({
                        cssClass: "k-i-custom",
                        type: "button",
                        tooltip: ""
            ...
            init: function (t, i) {
                ...
                if (k) {
                    ...
                    s.find(".k-combobox .k-input").keydown(function (t) {
                        ...
                        else if (a == c.TAB && !t.ctrlKey && !t.altKey)
                            if (t.shiftKey) {
        ...
        F = {
            ...
            lastTextNode: function (e) {
                ...
                for (var n = e.lastChild; n; n = n.previousSibling)
                    if (t = F.lastTextNode(n)) return t;
                return t
            },
            is: function (e, t) {
                return F.name(e) == t
                    ...
                    if (l.length)
                        for (l.sort(function (e, t) {
                            ...
                            if (p.push(" "), p.push(v), p.push('="'), "style" == v)
                                for (var k = u(_ || n.style.cssText).split(";"), b = 0, w = k.length; w > b; b++) {
                                    var y = k[b];
                                    if (y.length) {
                                        var x = c.exec(y),
                                            C = u(x[1].toLowerCase()),
...
function (e) {
    ...
    function a(e, t, n) {
        ...
        do a.insertBefore(i, i.previousSibling), r.moveToElementText(i); while (r.compareEndPoints(n ? "StartToStart" : "StartToEnd", e) > 0 && i.previousSibling);
    ...
    var o = window.kendo,
        ...
        x = s.extend({
            ...
            remove: function (e) {
                ...
                if (3 == a.nodeType)
                    for (; a.previousSibling && 3 == a.previousSibling.nodeType;) a = a.previousSibling, d += a.nodeValue.length;
                if (3 == o.nodeType)
                    for (; o.previousSibling && 3 == o.previousSibling.nodeType;) o = o.previousSibling, c += o.nodeValue.length;
    ...
    var t = window.kendo,
        ...
        y = n.extend({
            ...
            splittableParent: function (e, t) {
                ...
                if (n = t.parentNode, i = t.ownerDocument.body, o.isInline(n))
                    for (; n.parentNode != i && !o.isBlock(n.parentNode);) n = n.parentNode;
                return n
            },
            paste: function (e, t) {
                ...
                for (var n, i = o.create(document, "div", {
                    ...
                    if (u && "p" == o.name(c)) {
                        var p = parseFloat(c.style.marginLeft || 0),
                            f = s[u][p];
                        if ((p > a || !f) && (f = o.create(document, u), l == i ? o.insertBefore(f, c) : l.appendChild(f), s[u][p] = f), n != u)
                            for (var h in s)
                                for (var m in s[h]) e.contains(f, s[h][m]) && delete s[h][m];
        ...
        g = i.extend({
            ...
            findFormat: function (e) {
                ...
                for (t = 0, n = o.length; n > t; t++) {
                    ...
                    for (; i;)
                        if (i = c.parentOfType(i, r), i && s(i, a)) return i
                }
                return null
            },
        ...
        v = i.extend({
            ...
            split: function (e) {
                var t, n, i = u.textNodes(e),
                    r = i.length;
                if (r > 0)
                    for (t = 0; r > t; t++) n = this.finder.findFormat(i[t]), n && u.split(e, n, !0)
            },
        ...
        _ = g.extend({
            ...
            getInlineCssValue: function (t) {
                ...
                if (m)
                    for (n = 0, i = m.length; i > n; n++)
                        if (r = m[n], a = r.nodeName, o = r.nodeValue, r.specified && "style" == a)
                            for (s = g(o || t.style.cssText).split(";"), d = 0, u = s.length; u > d; d++)
                                if (l = s[d], l.length) {
            ...
            getFormatInner: function (t) {
                var n, i, r, a = e(c.isDataNode(t) ? t.parentNode : t),
                    o = a.parents().andSelf();
                for (n = 0, i = o.length; i > n; n++)
                    if (r = "className" == this.greedyProperty ? o[n].className : this.getInlineCssValue(o[n])) return r;
                return "inherit"
            },
    ...
    var t = window.kendo,
        ...
        m = n.extend({
            ...
            contains: function (e, t) {
                var n, i, r;
                for (n = 0, i = t.length; i > n; n++)
                    if (r = t[n], !r || !o.isAncestorOrSelf(e, r)) return !1;
                return !0
            },
            findSuitable: function (t) {
                ...
                for (n = 0, i = s.length; i > n; n++)
                    if (this.contains(s[n], s)) return [s[n]];
                return s
            },
            findFormat: function (e) {
                var t, n, i, r, a, s = this.format;
                for (t = 0, n = s.length; n > t; t++)
                    for (i = e, r = s[t].tags, a = s[t].attr; i;) {
        ...
        g = n.extend({
            ...
            apply: function (e) {
                var t, n, r = this,
                    ...
                    d = i({}, s.attr, r.values);
                if (a.length)
                    for (t = 0, n = a.length; n > t; t++) o.attr(a[t], d);
                else r.wrap(l, d, e)
            },
            remove: function (e) {
                var t, n, i, r;
        ...
        v = n.extend({
            ...
            apply: function (e) {
                var t, n, i, a, s, l = this.format,
                    ...
                    c = l[0].tags[0];
                if (d.length)
                    for (t = 0, n = d.length; n > t; t++) o.is(d[t], "li") ? (i = d[t].parentNode, a = new r.ListFormatter(i.nodeName.toLowerCase(), c), s = this.editor.createRange(), s.selectNode(d[t]), a.toggle(s)) : o.changeTag(d[t], c);
        ...
        m = n.extend({
            ...
            wrap: function (e, t) {
                ...
                for (n = 0; t.length > n; n++)
                    if (i = t[n], a.is(i, "li")) e.appendChild(i);
                    else if (a.is(i, "ul") || a.is(i, "ol"))
            ...
            containsAny: function (e, t) {
                for (var n = 0; t.length > n; n++)
                    if (a.isAncestorOrSelf(e, t[n])) return !0;
                return !1
            },
            ...
            applyOnSection: function (t, n) {
                ...
                var r, o = this.tag;
                r = 1 == n.length ? a.parentOfType(n[0], ["ul", "ol"]) : a.commonAncestor.apply(null, n), r || (r = a.parentOfType(n[0], ["p", "td"]) || n[0].ownerDocument.body), a.isInline(r) && (r = a.blockParentOrBody(r));
                var s = [],
...
function (e) {
    var t = window.kendo,
        ...
        _ = l.extend({
            ...
            exec: function () {
                function n(t) {
                    var n, i, a, o = g.element,
                        s = e("#k-editor-link-url", o).val();
                    s && "http://" != s && (d.attributes = {
                        href: s
                    }, n = e("#k-editor-link-title", o).val(), n && (d.attributes.title = n), i = e("#k-editor-link-text", o).val(), i !== p && (d.attributes.innerHTML = i || s), a = e("#k-editor-link-target", o).is(":checked"), a && (d.attributes.target = "_blank"), d.formatter.apply(c, d.attributes)), r(t), d.change && d.change()
                }

                function r(e) {
                    e.preventDefault(), g.destroy(), a.windowFromDocument(o.documentFromRange(c)).focus(), d.releaseRange(c)
                }
                var l, d = this,
                    c = d.getRange(),
                    u = c.collapsed,
                ...
                var h = l.length ? d.formatter.finder.findSuitable(l[0]) : null,
                    m = 1 >= l.length || 2 == l.length && u,
                    g = s.createDialog(d._dialogTemplate(m), d.editor, i({}, d.editor.options.dialogOptions, {
                        title: "Insert link",
                        close: r
                    })).hide().find(".k-dialog-insert").click(n).end().find(".k-dialog-close").click(r).end().find(".k-form-text-row input").keydown(function (e) {
                        var i = t.keys;
                        e.keyCode == i.ENTER ? n(e) : e.keyCode == i.ESC && r(e)
                    }).end().find("#k-editor-link-url").val(h ? h.getAttribute("href", 2) : "http://").end().find("#k-editor-link-text").val(l.length > 0 ? 1 == l.length ? l[0].nodeValue : l[0].nodeValue + l[1].nodeValue : "").end().find("#k-editor-link-title").val(h ? h.title : "").end().find("#k-editor-link-target").attr("checked", h ? "_blank" == h.target : !1).end().show().data("kendoWindow").center();
                    ...
                    for (; c.length;)
                        if (a = c.shift(), s.is(a, "li")) {
                            ...
                            if (p && l[0]) u[0] ? (u.append(a), u.append(e(p).children()), s.remove(p)) : (l.append(p), p.insertBefore(a, p.firstChild));
                                ...
                                for (p = l.children("ul,ol")[0], p || (p = s.create(a.ownerDocument, s.name(o)), l.append(p)); a && a.parentNode == o;) p.appendChild(a), a = c.shift()
                        } else {
        ...
        b = u.extend({
            ...
            update: function (i, r) {
                ...
                for (l = 0, d = c.length; d > l; l++)
                    if (a = n(c[l]), a || (o = e(c[l]).parents("ul,ol").length, a = s.is(c[l], "li") && (o > 1 || n(c[l].parentNode)) || s.ofType(c[l], ["ul", "ol"]) && o > 0), a) return i.removeClass("k-state-disabled"), t;
...
function (e) {
    var t = window.kendo,
        ...
        s = n.extend({
            ...
            apply: function (e) {
                if (this.hasPending()) {
                    ...
                    var n = e.startContainer.childNodes[e.startOffset],
                        r = n.previousSibling;
                    if (r ? (r.nodeValue || (r = r.previousSibling), e.setStart(r, r.nodeValue.length - 1)) : e.setStart(r, 0), t.add(e), !a.textNodes(e).length) return t.remove(e), e.collapse(!0), this.editor.selectRange(e), void 0;
            ...
            toggle: function (e) {
                for (var t = this.formats, n = 0; t.length > n; n++)
                    if (t[n].name == e.name) return t[n].params && t[n].params.value != e.params.value ? t[n].params.value = e.params.value : t.splice(n, 1), void 0;
                t.push(e)
            },
            clear: function () {
                this.formats = []
...
function (e, t) {
    ...
    function i(n, i) {
        ...
        if (document.selection)
            if (e(n).is(":visible") && n.focus(), r = document.selection.createRange(), a) r.move("character", i), r.select();
            else {
    ...
    var r = window.kendo,
        ...
        N = {
            ...
            _input: function () {
                var t, n = this,
                    i = "k-formatted-value",
                    r = n.element.addClass(h).show()[0],
                    a = r.accessKey,
                    o = n.wrapper;
                t = o.find(T + i), t[0] || (t = e('<input type="text"/>').insertBefore(r).addClass(i)), t[0].style.cssText = r.style.cssText, t[0].tabIndex = r.tabIndex, r.tabIndex = 0, r.type = "text", t.attr("placeholder", n.options.placeholder), a && (t.attr("accesskey", a), r.accessKey = ""), n._text = t.attr("readonly", !0).addClass(r.className)
            },
            _keydown: function (e) {
                var t = this,
                    n = e.keyCode;
            ...
            _prevent: function (e, t) {
                var n, r = this,
                    ...
                    f = i(o),
                    h = !0;
                return p === D && (p = c.decimals), e > 16 && 21 > e || e > 32 && 37 > e || e > 47 && 58 > e || e > 95 && 106 > e || e == a.INSERT || e == a.DELETE || e == a.LEFT || e == a.RIGHT || e == a.TAB || e == a.BACKSPACE || e == a.ENTER ? (h = !1, t && (n = parseInt(String.fromCharCode(e), 10), isNaN(n) || (o.value = s.substring(0, f) + n + s.substring(f), h = !0))) : N[e] === u && p > 0 && -1 == s.indexOf(u) ? h = !1 : !(d === D || 0 > d) || -1 != s.indexOf("-") || 189 != e && 109 != e && 173 != e || 0 !== f ? 110 == e && p > 0 && -1 == s.indexOf(u) && (o.value = s.substring(0, f) + u + s.substring(f)) : h = !1, h
            },
            _option: function (e, n) {
                var i = this,
                    r = i.options;
...
function (e, t) {
    ...
    var l = window.kendo,
        d = l.ui,
        c = l.support.touch && l.support.mobileOS,
        u = c || l.support.pointers,
        p = l.support.mousedown,
        f = l.support.click,
        h = e.extend,
        m = e.proxy,
        g = e.each,
        ...
        A = "select",
        I = "zIndex",
        R = l.support.pointers ? "MSPointerOver" : "mouseenter",
        z = l.support.pointers ? "MSPointerOut" : "mouseleave",
        H = "kendoPopup",
        O = "k-state-default",
        M = "k-state-hover",
        P = "k-state-focused",
        ...
        U = "k-state-active",
        W = ":not(.k-list) > .k-item",
        V = ".k-item.k-state-disabled",
        q = ".k-item:not(.k-state-disabled)",
        j = ".k-item:not(.k-state-disabled) > .k-link",
        $ = "div:not(.k-animation-container,.k-list-container)",
        G = {
            content: v("<div class='k-content k-group'>#= content(item) #</div>"),
            group: v("<ul class='#= groupCssClass(group) #'#= groupAttributes(group) # role='menu' aria-hidden='true'>#= renderItems(data) #</ul>"),
            itemWrapper: v("<#= tag(item) # class='#= textClass(item) #'#= textAttributes(item) #>#= image(item) ##= sprite(item) ##= text(item) ##= arrow(data) #</#= tag(item) #>"),
            item: v("<li class='#= wrapperCssClass(group, item) #' role='menuitem' #=item.items ? \"aria-haspopup='true'\": \"\"##=item.enabled === false ? \"aria-disabled='true'\" : ''#>#= itemWrapper(data) ## if (item.items) { ##= subGroup({ items: item.items, menu: menu, group: { expanded: item.expanded } }) ## } #</li>"),
            image: v("<img class='k-image' alt='' src='#= imageUrl #' />"),
            ...
            init: function (t, n) {
                var i = this;
                k.fn.init.call(i, t, n), t = i.wrapper = i.element, n = i.options, n.dataSource && (i.element.empty(), i.append(n.dataSource, t)), i._updateClasses(), n.animation === !1 && (n.animation = {
                    open: {
                        effects: {}
                    },
                    close: {
                    ...
                    i.element[0].blur(), i.element[0].focus(), setTimeout(function () {
                        i._moveHover([], e(l.eventTarget(t)).closest(W))
                    }, 200)
                }).on("MSPointerDown", function (t) {
                    i._oldHoverItem = e(t.target).closest(W)
                }).on(f + w, V, !1).on(f + w, q, m(i._click, i)).on("keydown" + w, m(i._keydown, i)).on("focus" + w, m(i._focus, i)).on("blur" + w, m(i._removeHoverItem, i)).on(R + w, q, m(i._mouseenter, i)).on(z + w, q, m(i._mouseleave, i)).on(R + w + " " + z + w + " " + p + w + " " + f + w, j, m(i._toggleHover, i)), n.openOnClick && (i.clicked = !1, i._documentClickHandler = m(i._documentClick, i), e(document).click(i._documentClickHandler)), t.attr("role", "menubar"), t[0].id && (i._ariaId = l.format("{0}_mn_active", t[0].id)), l.notify(i)
            },
            events: [x, F, A],
            options: {
                name: "Menu",
            ...
            destroy: function () {
                var t = this;
                k.fn.destroy.call(t), t.element.off(w), t._documentClickHandler && e(document).unbind("click", t._documentClickHandler)
            },
            enable: function (e, t) {
            ...
            _insert: function (t, n, i) {
                ...
                return n && !i.length && (i = e(K.renderGroup({
                    group: c
                })).appendTo(n)), d || e.isArray(t) ? (r = e.map(d ? [t] : t, function (t, n) {
                    return "string" == typeof t ? e(t) : e(K.renderItem({
                        group: c,
                        item: h(t, {
                            index: n
                        })
                    ...
                    return t.content || t.contentUrl ? e(K.renderContent({
                        item: h(t, {
                            index: n
                        })
                    })) : !1
            ...
            remove: function (e) {
                ...
                var t = this,
                    n = e.parentsUntil(t.element, W),
                    i = e.parent("ul");
                if (e.remove(), i && !i.children(W).length) {
                ...
                return r = a.element.find(r), /^(top|bottom|default)$/.test(d) && (d = c ? s ? (d + " left").replace("default", "bottom") : "left" : s ? (d + " right").replace("default", "bottom") : "right"), r.siblings().find(">.k-popup:visible,>.k-animation-container>.k-popup:visible").each(function () {
                    ...
                    clearTimeout(r.data(D)), r.data(D, setTimeout(function () {
                        ...
                        if (l[0] && a.trigger(x, {
                            ...
                            r.data(I, r.css(I)), r.css(I, a.nextItemZIndex++), e = l.data(H);
                            var u = r.parent().hasClass(C),
                                p = u && s,
                                f = i(d, u, c),
                                m = o.animation.open.effects,
                                g = m !== t ? m : "slideIn:" + n(d, u);
                            e ? (e = l.data(H), e.options.origin = f.origin, e.options.position = f.position, e.options.animation.open.effects = g) : e = l.kendoPopup({
                                origin: f.origin,
                                position: f.position,
                                ...
                                close: function (e) {
                                    ...
                                    a.trigger(F, {
                                        item: t[0]
                                    }) ? e.preventDefault() : (t.css(I, t.data(I)), t.removeData(I))
                                }
            ...
            _toggleHover: function (t) {
                var n = e(l.eventTarget(t) || t.target).closest(W),
                    i = t.type == R || -1 !== p.indexOf(t.type);
                n.parents("li." + B).length || n.toggleClass(M, i), this._removeHoverItem()
            },
            _removeHoverItem: function () {
                var e = this._oldHoverItem;
                e && e.hasClass(P) && (e.removeClass(P), this._oldHoverItem = null)
            },
            _updateClasses: function () {
                var e, t = this.element;
                t.addClass("k-widget k-reset k-header " + C).addClass(C + "-" + this.options.orientation), t.find("li > ul").addClass("k-group").attr("role", "menu").attr("aria-hidden", t.is(":visible")), e = t.find("> li,.k-group > li"), e.each(function () {
                    a(this)
                })
            },
            _mouseenter: function (t) {
                var n = this,
                    i = e(t.currentTarget),
                    a = i.children(".k-animation-container").length || i.children(L).length;
                t.delegateTarget == i.parents(".k-menu")[0] && ((!n.options.openOnClick || n.clicked) && !r(t.currentTarget, t.relatedTarget) && a && n.open(i), (n.options.openOnClick && n.clicked || u) && i.siblings().each(m(function (e, t) {
                    n.close(t)
                }, n)))
            },
            _mouseleave: function (n) {
                var i = this,
                    a = e(n.currentTarget),
                    o = a.children(".k-animation-container").length || a.children(L).length;
                return a.parentsUntil(".k-animation-container", ".k-list-container,.k-calendar-container")[0] ? (n.stopImmediatePropagation(), t) : (i.options.openOnClick || c || l.support.pointers && 2 == n.originalEvent.pointerType || r(n.currentTarget, n.relatedTarget) || !o || i.close(a), t)
            },
            _click: function (n) {
                var i, r, a, o = this,
                    s = o.options,
                ...
                if (!f.children($)[0]) return f.hasClass(B) ? (n.preventDefault(), t) : (n.handled || !o.trigger(A, {
                    item: f[0]
            ...
            _keydown: function (e) {
                ...
                if (e.target == e.currentTarget || o == _.ESC) {
                    if (s || (s = a._oldHoverItem = a._hoverItem()), i = a._itemBelongsToVertival(s), r = a._itemHasChildren(s), o == _.RIGHT) n = a[d ? "_itemLeft" : "_itemRight"](s, i, r);
                    else if (o == _.LEFT) n = a[d ? "_itemRight" : "_itemLeft"](s, i, r);
                    else if (o == _.DOWN) n = a._itemDown(s, i, r);
                    else if (o == _.UP) n = a._itemUp(s, i, r);
                    else if (o == _.ESC) n = a._itemEsc(s, i);
                    else if (o == _.ENTER || o == _.SPACEBAR) n = s.children(".k-link"), n.length > 0 && (a._click({
                        target: n[0],
                        preventDefault: function () {}
                    }), a._moveHover(s, a._findRootParent(s)));
                    else if (o == _.TAB) return n = a._findRootParent(s), a.close(n), a._moveHover(s, n), t;
            ...
            _moveHover: function (e, t) {
                var n = this,
                    i = n._ariaId;
                e.length && t.length && (e.removeClass(P), e[0].id === i && e.removeAttr("id")), t.length && (t[0].id && (i = t[0].id), t.addClass(P), n._oldHoverItem = t, i && (n.element.removeAttr("aria-activedescendant"), t.attr("id", i), n.element.attr("aria-activedescendant", i)))
            },
    ...
    h(K, {
        renderItem: function (e) {
            ...
            var t = G.empty,
                n = e.item;
            return G.item(h(e, {
                image: n.imageUrl ? G.image : t,
                sprite: n.spriteCssClass ? G.sprite : t,
                itemWrapper: G.itemWrapper,
                arrow: n.items || n.content ? G.arrow : t,
                subGroup: K.renderGroup
            }, Y))
        },
        renderGroup: function (e) {
            return G.group(h({
                renderItems: function (e) {
                    for (var t = "", n = 0, i = e.items, r = i ? i.length : 0, a = h({
                            length: r
                        }, e.group); r > n; n++) t += K.renderItem(h(e, {
                        group: a,
                        item: h({
                            index: n
                        }, i[n])
...
function (e, t) {
    ...
    function a(e) {
        var t, n, i, r, a, o;
        if (e && e.length)
            for (o = [], t = 0, n = e.length; n > t; t++) i = e[t], a = i.text || i.value || i, r = null == i.value ? i.text || i : i.value, o[t] = {
                text: a,
                value: r
            };
        return o
...
function (e) {
    ...
    var i = window.kendo,
        ...
        l = "kendoPopup",
        d = ".kendoFilterMenu",
        c = _T_("grid.eqEnum", "Is equal to"),
        u = _T_("grid.neqEnum", "Is not equal to"),
        p = r.Widget,
        ...
        m = p.extend({
            init: function (t, r) {
                ...
                p.fn.init.call(g, t, r), m = r.operators || {}, t = g.element, r = g.options, r.appendToElement ? g.link = e() : (c = t.addClass("k-filterable").find(".k-grid-filter"), c[0] || (c = t.prepend('<a class="k-grid-filter" href="#"><span class="k-icon k-filter"/></a>').find(".k-grid-filter")), c.attr("tabindex", -1).on("click" + d, s(g._click, g))), g._refreshHandler = s(g.refresh, g), g.dataSource = r.dataSource.bind("change", g._refreshHandler), g.field = r.field || t.attr(i.attr("field")), g.model = g.dataSource.reader.model, g._parse = function (e) {
                    return e + ""
                }, g.model && g.model.fields && (u = g.model.fields[g.field], u && (v = u.type || "string", u.parse && (g._parse = s(u.parse, u)))), r.values && (v = "enums"), m = m[v] || r.operators[v];
                var _;
                for (_ in m) break;
                g._defaultFilter = function () {
                    return {
                        field: g.field,
                        operator: _ || "eq",
                        value: ""
                    }
                }, g.form = e('<form class="k-filter-menu"/>').html(i.template("boolean" === v ? f : h)({
                    field: g.field,
                    ns: i.ns,
                    messages: r.messages,
                    extra: r.extra,
            ...
            filter: function (e) {
                if (typeof (e.filters[0].value) !== "number") {                    
            ...
            options: {
                ...
                operators: {
                    string: {
                        eq: c,
                        neq: u,
                        startswith: _T_("grid.startswith", "Starts with"),
                        contains: _T_("grid.contains", "Contains"),
                        doesnotcontain: _T_("grid.Doesnotcontain", "Does not contain"),
                        endswith: _T_("grid.endswith", "Ends with")
                    },
                    number: {
                        eq: c,
                        neq: u,
                        gte: _T_("grid.gte", "Is greater than or equal to"),
                        gt: _T_("grid.gt", "Is greater than"),
                        lte: _T_("grid.lte", "Is less than or equal to"),
                        lt: _T_("grid.lt", "Is less than")
                    },
                    date: {
                        eq: c,
                        neq: u,
                        gte: _T_("grid.gteDate", "Is after or equal to"),
                        gt: _T_("grid.gtDate", "Is after"),
                        lte: _T_("grid.lteDate", "Is before or equal to"),
                        lt: _T_("grid.ltDate", "Is before")
                    },
                    enums: {
                        eq: c,
                        neq: u
                ...
                messages: {
                    info: _T_("grid.Info", "Show items with value that:"),// sets the text on top of the filter menu
                    isTrue: _T_("grid.IsTrue", "Is true"), // sets the text for "isTrue" radio button
                    isFalse: _T_("grid.IsFalse", "Is false"), // sets the text for "isFalse" radio button
                    filter: _T_("grid.Filter", "Filter"), // sets the text for the "Filter" button
                    clear: _T_("grid.Clear", "Clear"), // sets the text for the "Clear" button
                    //changes the text of the "And" and "Or" of the filter menu
                    and: _T_("grid.And", "And"),
                    or: _T_("grid.Or", "Or"),
                    selectValue: _T_("grid.selectvalue", "-Select value-")
                }
            }
        });
    r.plugin(m)
    ...
    var r = window.kendo,
        ...
        Z = {
            ...
            init: function (t, n) {
                ...
                }).on(N + p + " " + A + p, W, a._toggleHover).on("touchend" + p + " click" + p, V, !1).on("keydown" + p, e.proxy(a._keydown, a)).on("focus" + p, function () {
                    var e = a.select();
            ...
            select: function (n) {
                var i = this;
                return n === t ? i.element.find(q).parent() : (i.element.find(n).each(function () {
                    var n = e(this),
                        r = n.children(v);
            ...
            append: function (t, r) {
                ...
                var a = this._insert(t, r, r.length ? r.find(z) : null);
            ...
            _prevItem: function (e) {
                ...
                var t, n = e.prev();
                if (n[0])
                    for (t = n; t[0];) t = t.children(w).children("." + m), t[0] && (n = t);
            ...
            _toggleHover: function (t) {
                var n = e(t.currentTarget);
                n.parents("li." + M).length || n.toggleClass("k-state-hover", t.type == N)
            },
            _updateClasses: function () {
                var t, r, a = this;
            ...
            _collapseAllExpanded: function (t) {
                ...
                if (t.children(v).hasClass("k-header")) {
                    var a = t.find(z).add(t.find(H));
                    return a.is(Q) && (r = !0), a.is(Q) || 0 === a.length || (n = e(i.element).children(), n.find(z).add(n.find(H)).filter(function () {
                        return e(this).is(Q)
                    }).each(function (t, n) {
            ...
            _updateSelected: function (e) {
                var t = this,
                    ...
                    i = e.parent(k),
                    r = t._selected;
                r && r.removeAttr(K), t._selected = i.attr(K, !0), n.find(q).removeClass(P), n.find("> .k-state-highlighted, .k-panel > .k-state-highlighted").removeClass(L), e.addClass(P), e.parentsUntil(n, k).filter(":has(.k-header)").addClass(L), t._current(i)
            }
        });
    s(tt, {
        renderItem: function (e) {
...
function (e, t) {
    function n(t) {
        t.children(m).addClass(x), t.children("a").addClass(_).children(m).addClass(x), t.filter(":not([disabled]):not([class*=k-state-disabled])").addClass(R), t.filter("li[disabled]").addClass(I).removeAttr("disabled"), t.filter(":not([class*=k-state])").children("a").filter(":focus").parent().addClass(z + " " + M), t.attr("role", "tab"), t.filter("." + z).attr("aria-selected", !0), t.each(function () {
            var t = e(this);
    ...
    var r = window.kendo,
        ...
        W = {
            ...
            init: function (t, n) {
                ...
                }).on(E + h + " " + N + h, L, i._toggleHover).on("keydown" + h, e.proxy(i._keydown, i)).on("focus" + h, e.proxy(i._active, i)).on("blur" + h, function () {
                    i._current(null)
                ...
                var a = i.tabGroup.children("li." + z),
                    o = i.contentHolder(a.index());
            ...
            _active: function () {
                var e = this.tabGroup.children().filter("." + z);
            ...
            _current: function (e) {
                var n = this,
                    i = n._focused,
                    r = n._ariaId;
                return e === t ? i : (i && (i[0].id === r && i.removeAttr("id"), i.removeClass(H)), e && (e.hasClass(z) || e.addClass(H), n.element.removeAttr("aria-activedescendant"), r = e[0].id || r, r && (e.attr("id", r), n.element.attr("aria-activedescendant", r))), n._focused = e, t)
            },
            _keydown: function (e) {
                var n, i = this,
                    r = e.keyCode,
            ...
            refresh: function (e) {
                ...
                if ("add" == e.action) o.tabGroup.children().length > e.index ? o.insertBefore(h, o.tabGroup.children().eq(e.index)) : o.append(h);
                    ...
                    for (t = 0; m.length > t; t++) o.remove(e.index);
            ...
            events: [T, S, w, A, "change", "dataBinding", "dataBound"],
            options: {
                name: "TabStrip",
                dataTextField: "",
                dataContentField: "",
            ...
            select: function (t) {
                var n = this;
                return 0 === arguments.length ? n.tabGroup.children("li." + z) : (isNaN(t) || (t = n.tabGroup.children().get(t)), t = n.tabGroup.find(t), e(t).each(function (t, i) {
                    i = e(i), i.hasClass(z) || n.trigger(T, {
                        item: i[0],
            ...
            _create: function (i) {
                ...
                return o || e.isArray(i) ? (i = e.isArray(i) ? i : [i], r = s(i, function (t, n) {
                    ...
                    return n.content || n.contentUrl ? e(q.renderContent({
                        item: c(n, {
                            index: i
                        })
                    })) : t
            ...
            _updateClasses: function () {
                ...
                }).remove()), a >= 0 && r.eq(a).addClass(M), s.contentElements = s.wrapper.children("div"), s.contentElements.addClass(F).eq(o).addClass(z).css({
                    display: "block"
            ...
            _updateContentElements: function () {
                ...
                t.tabGroup.find(".k-item").each(function (r) {
                    var o = a.eq(r),
                        s = i + "-" + (r + 1);
                    this.setAttribute("aria-controls", s), !o.length && n[r] ? e("<div id='" + s + "' class='" + F + "'/>").appendTo(t.wrapper) : o.attr("id", s), o.attr("role", "tabpanel"), o.filter(":not(." + z + ")").attr("aria-hidden", !0).attr("aria-expanded", !1), o.filter("." + z).attr("aria-expanded", !0)
            ...
            _click: function (e) {
                var t, n, i = this,
                    r = e.find("." + _),
                    a = r.attr(g),
                    o = i.options.collapsible,
                    s = i.contentHolder(e.index());
                if (e.closest(".k-widget")[0] == i.wrapper[0]) {
                    if (e.is("." + I + (o ? "" : ",." + z))) return !0;
                    if (!i.tabGroup.children("[data-animating], [data-in-request]").length) {
                        if (i.trigger(T, {
                            item: e[0],
                            contentElement: s[0]
                        })) return !0;
                        if (n = r.data(D) || a && ("#" == a.charAt(a.length - 1) || -1 != a.indexOf("#" + i.element[0].id + "-")), !a || n) return t = !0, o && e.is("." + z) ? (i.deactivateTab(e), !0) : (i.activateTab(e) && (t = !0), t)
                    }
                }
            },
            deactivateTab: function (e) {
                ...
                e = t.tabGroup.find(e), a = c(o ? a : c({
                    ...
                    duration: i.duration
                }), e.kendoRemoveClass(z, {
                    duration: i.duration
                })) : (e.addClass(R), e.removeClass(z)), e.removeAttr("aria-selected"), t.contentAnimators.filter("." + z).kendoStop(!0, !0).kendoAnimate(a).removeClass(z).attr("aria-hidden", !0)
            },
            activateTab: function (e) {
                ...
                a = c(o ? a : c({
                    ...
                    hide: !0
                }), r.size(i.effects) ? (l.kendoRemoveClass(z, {
                    duration: a.duration
                }), e.kendoRemoveClass(O, {
                    duration: a.duration
                })) : (l.removeClass(z), e.removeClass(O));
                var u = t.contentAnimators;
                if (0 === u.length) return l.removeClass(M), e.addClass(M).css("z-index"), e.addClass(z), t._current(e), t.trigger("change"), !1;
                var p = u.filter("." + z),
                    f = t.contentHolder(d),
                    h = f.closest(".k-content");
                if (0 === f.length) return p.removeClass(z).attr("aria-hidden", !0).kendoStop(!0, !0).kendoAnimate(a), !1;
                e.attr("data-animating", !0);
                var m = (e.children("." + _).data(D) || !1) && f.is(y),
                    g = function () {
                        l.removeClass(M), e.addClass(M).css("z-index"), r.size(i.effects) ? (l.kendoAddClass(R, {
                            duration: i.duration
                        }), e.kendoAddClass(z, {
                            duration: i.duration
                        })) : (l.addClass(R), e.addClass(z)), l.removeAttr("aria-selected"), e.attr("aria-selected", !0), t._current(e), h.addClass(z).removeAttr("aria-hidden").kendoStop(!0, !0).attr("aria-expanded", !0).kendoAnimate(c({
                            init: function () {
                                t.trigger(S, {
                                    item: e[0],
                                    contentElement: f[0]
                ...
                return p.removeClass(z), p.attr("aria-hidden", !0), p.attr("aria-expanded", !1), p.length ? p.kendoStop(!0, !0).kendoAnimate(c({
                    complete: v
                }, a)) : v(), !0
            },
            contentElement: function (e) {
                ...
                if (n)
                    for (var a = 0, o = n.length; o > a; a++)
                        if (i.test(n.closest(".k-content")[a].id)) return n[a];
                return t
            },
            ...
            ajaxRequest: function (t, n, i, r) {
                if (t = this.tabGroup.find(t), !t.find(".k-loading").length) {
                    ...
                    t.attr("data-in-request", !0), e.ajax({
                        ...
                        success: function (e) {
                            n.html(e), i && i.call(a, n), a.trigger(A, {
                                item: t[0],
                                contentElement: n[0]
                            })
                        }
...
function (e, t) {
    function n(e, t, n) {
        ...
        e.setTime(e.getTime() + t), n || (i = e.getTimezoneOffset() - r, e.setTime(e.getTime() + i * F))
    }

    function i() {
        var e = new B,
            t = new B(e.getFullYear(), e.getMonth(), e.getDate(), 0, 0, 0),
            n = new B(e.getFullYear(), e.getMonth(), e.getDate(), 12, 0, 0);
        return -1 * (t.getTimezoneOffset() - n.getTimezoneOffset())
    }

    function r(e) {
        return 60 * e.getHours() * F + e.getMinutes() * F + 1e3 * e.getSeconds() + e.getMilliseconds()
    }

    function a(e, t, n) {
        var i, a = r(t),
            o = r(n);
        return e && a != o ? (i = r(e), a > i && (i += D), a > o && (o += D), i >= a && o >= i) : !0
    }
    ...
    var U = function (t) {
        ...
        }).on(_, w, P(n._click, n)).on("mouseenter" + v, w, function () {
            e(this).addClass(C)
        }).on("mouseleave" + v, w, function () {
            e(this).removeClass(C)
        }), n.list = e("<div class='k-list-container'/>").append(n.ul).on(S, s), i && (n._timeViewID = i + "_timeview", n._optionID = i + "_option_selected", n.ul.attr(H, n._timeViewID)), n._popup(), n.template = l.template('<li tabindex="-1" role="option" class="k-item" unselectable="on">#=data#</li>', {
            useWithBlock: !1
        })
    };
    U.prototype = {
        current: function (n) {
            var i = this,
                r = i.options.active;
            return n === t ? i._current : (i._current && i._current.removeClass(E).removeAttr(A).removeAttr(H), n && (n = e(n).addClass(E).attr(H, i._optionID).attr(A, !0), i.scroll(n[0])), i._current = n, r && r(n), t)
        },
        close: function () {
            this.popup.close()
        },
        ...
        refresh: function () {
            var e, t = this,
                ...
                _ = 0,
                k = "";
            for (e = d ? (D + s * F) / h : D / h, p != f && (p > f && (f += D), e = (f - p) / h + 1); e > _; _++) _ && n(v, h, d), f && r(v) > f && (v = new B(+u)), k += g(m(v, o, a.culture));
            t._html(k, e)
        },
        bind: function () {
            var e = this,
        ...
        _adjustListWidth: function () {
            ...
            (n.data("width") || !i) && (e = window.getComputedStyle ? window.getComputedStyle(r[0], null) : 0, t = e ? parseFloat(e.width) : r.outerWidth(), e && (u.mozilla || u.msie) && (t += parseFloat(e.paddingLeft) + parseFloat(e.paddingRight) + parseFloat(e.borderLeftWidth) + parseFloat(e.borderRightWidth)), i = t - (n.outerWidth() - n.width()), n.css({
                    fontFamily: r.css("font-family"),
                    width: i
                }).data("width", i))
        },
        _popup: function () {
            var e = this,
                ...
                n = e.options,
                i = n.anchor;
            e.popup = new p.Popup(t, M(n.popup, {
                anchor: i,
                open: n.open,
                close: n.close,
                animation: n.animation,
                isRtl: l.support.isRtl(n.anchor)
            })), l.touchScroller(e.popup.element)
        },
        move: function (e) {
            var n = this,
                i = e.keyCode,
    ...
    }, U.getMilliseconds = r, l.TimeView = U;
    var W = f.extend({
        init: function (e, t) {
            var n, i, r = this;
            f.fn.init.call(r, e, t), e = r.element, t = r.options, o(t), r._wrapper(), r.timeView = i = new U(M({}, t, {
                id: e.attr(H),
                anchor: r.wrapper,
                format: t.format,
                change: function (t, n) {
                ...
                open: function (t) {
                    r.timeView._adjustListWidth(), r.trigger(h) ? t.preventDefault() : (e.attr(I, !0), n.attr(R, !1))
                },
                close: function (t) {
                    r.trigger(m) ? t.preventDefault() : (e.attr(I, !1), n.attr(R, !0))
                },
                active: function (t) {
                    e.removeAttr(z), t && e.attr(z, i._optionID)
                }
            })), n = i.ul, r._icon(), r._reset(), e[0].type = "text", e.addClass("k-input").on("keydown" + v, P(r._keydown, r)).on("blur" + v, P(r._blur, r)).on("focus" + v, function () {
                r._inputWrapper.addClass(x)
            }).attr({
                role: "textbox",
                "aria-haspopup": !0,
                "aria-expanded": !1,
        ...
        setOptions: function (e) {
            var t = this,
                n = t.timeView,
                i = n.options;
            f.fn.setOptions.call(t, e), o(t.options), n.options = M(i, t.options, {
                active: i.active,
                change: i.change,
                close: i.close,
                open: i.open
        ...
        enable: function (e) {
            var t = this,
                n = t.element,
                i = t._arrow.off(v),
                r = t._inputWrapper.off(T);
            e === !1 ? (r.removeClass(k).addClass(N), n.attr(b, b)) : (r.removeClass(N).addClass(k).on(T, t._toggleHover), n.removeAttr(b), i.on(_, P(t._click, t)).on(S, s))
        },
        destroy: function () {
            var e = this;
        ...
        _wrapper: function () {
            var t, n = this,
                i = n.element;
            t = i.parents(".k-timepicker"), t[0] || (t = i.wrap(y).parent().addClass("k-picker-wrap k-state-default"), t = t.wrap(y).parent()), t[0].style.cssText = i[0].style.cssText, n.wrapper = t.addClass("k-widget k-timepicker k-header").addClass(i[0].className), i.css({
                width: "100%",
                height: i[0].style.height
        ...
        B = h.extend({
            ...
            _option: function (e, n) {
                ...
                if (n = o(n, r.parseFormats, r.culture)) {
                    if (r[e] = new R(+n), i.dateView[e](n), i._midnight = 0 === p(r.min) + p(r.max), l && u(n, l)) {
                        if (i._midnight && "max" == e) return s[e] = H, a.dataBind([H]), t;
                        s[e] = n
                    } else s.max = H, s.min = z;
                    a.bind()
                }
            },
            _toggleHover: function (t) {
            ...
            _update: function (t) {
                ...
                return +_ === +p._value ? (l = r.toString(_, f.format, f.culture), l !== t && p.element.val(null === _ ? t : l), _) : (null !== _ && u(_, h) ? _ = c(_, h, m) : d(_, h, m) || (_ = null), p._value = _, v.value(_), p.dateView.value(_), _ && (a = p._old, i = v.options, g[0] && (g = e.grep(g, function (e) {
                    return u(_, e)
                }), g[0] && (v.dataBind(g), s = !0)), s || (u(_, h) && (i.min = h, i.max = H, n = !0), u(_, m) && (p._midnight ? (v.dataBind([H]), s = !0) : (i.max = m, n || (i.min = z), n = !0))), !s && (!a && n || a && !u(a, _)) && (n || (i.max = H, i.min = z), v.bind())), p.element.val(_ ? r.toString(_, f.format, f.culture) : t), p._updateARIA(_), _)
            },
            _keydown: function (e) {
                var t = this,
                    n = t.dateView,
            ...
            _views: function () {
                ...
                l.dateView = e = new r.DateView(P({}, u, {
                    ...
                    close: function (e) {
                        l.trigger(g, O) ? e.preventDefault() : (c.attr(N, !1), n.attr(A, !0), t.popup.visible() || c.removeAttr(I))
                    },
                    open: function (t) {
                        l.trigger(m, O) ? t.preventDefault() : (s = o(c.val(), u.parseFormats, u.culture), s ? (l.dateView._current = s, l.dateView.calendar._focus(s)) : l.dateView.value(s), n.attr(A, !1), c.attr(N, !0).attr(I, e._dateViewID))
                    }
                    ...
                    close: function (t) {
                        l.trigger(g, M) ? t.preventDefault() : (i.attr(A, !0), c.attr(N, !1), e.popup.visible() || c.removeAttr(I))
                    },
                    open: function (e) {
                        t._adjustListWidth(), l.trigger(m, M) ? e.preventDefault() : (i.attr(A, !1), c.attr(N, !0).attr(I, t._timeViewID))
                    },
                    active: function (e) {
...
function (e, t) {
    ...
    function r(t) {
        var n, i, r = t.children("div"),
            ...
            l = r.children(".k-in");
        if (!t.hasClass("k-treeview") && (r.length || (r = e("<div />").prependTo(t)), !o.length && a.length ? o = e("<span class='k-icon' />").prependTo(r) : a.length && a.children().length || (o.remove(), a.remove()), s.length && e("<span class='k-checkbox' />").appendTo(r).append(s), !l.length))
            for (l = e("<span class='k-in' />").appendTo(r)[0], n = r[0].nextSibling, l = r.find(".k-in")[0]; n && "ul" != n.nodeName.toLowerCase();) i = n, n = n.nextSibling, 3 == i.nodeType && (i.nodeValue = e.trim(i.nodeValue)), l.appendChild(i)
    }
    ...
    s = n(".k-group"), l = n(".k-group,.k-content"), d = function (e) {
        ...
        _templates: function () {
            ...
            t.template && typeof t.template == B ? t.template = h(t.template) : t.template || (t.template = h("# var text = " + n("text") + "(item); #" + "# if (typeof item.encoded != 'undefined' && item.encoded === false) {#" + "#= text #" + "# } else { #" + "#: text #" + "# } #")), e._checkboxes(), e.templates = {
                wrapperCssClass: function (e, t) {
                    var n = "k-item",
                        i = t.index;
        ...
        _accessors: function () {
            var e, t, n, i = this,
                r = i.options,
                a = i.element;
            for (e in W) t = r[W[e]], n = a.attr(c.attr(e + "-field")), n && (t = n), t || (t = e), m(t) || (t = [t]), r[W[e]] = t
        },
        _fieldAccessor: function (t) {
            var n = this.options[W[t]],
                i = n.length,
                r = "(function(item) {";
        ...
        _updateIndeterminate: function (e) {
            ...
            if (a.length) {
                ...
                } else o = !t[0].indeterminate;
                i(a).data("indeterminate", !o).prop("indeterminate", !o).prop(T, o && t[0].checked), this._updateIndeterminate(a)
            }
        },
        ...
        parent: function (t) {
            var n, i, r = /\bk-treeview\b/,
                a = /\bk-item\b/;
            typeof t == B && (t = this.element.find(t)), V(t) || (t = t[0]), i = a.test(t.className);
            do t = t.parentNode, a.test(t.className) && (i ? n = t : i = !0); while (!r.test(t.className) && !n);
            return e(n)
        },
        ...
        _previousVisible: function (e) {
            ...
            if (!e.length || e.prev().length)
                for (t = e.length ? e.prev() : n.root.children().last(); n._expanded(t);) t = s(t).children().last();
            else t = n.parent(e) || e;
        ...
        _checkboxes: function () {
            ...
            (n || t.checkboxTemplate) && (t.checkboxTemplate ? e = t.checkboxTemplate : (e = "<input type='checkbox' #= item.checked ? 'checked' : '' #", n.name && (e += " name='" + n.name + "'"), e += " />"), n = f({
                    template: e
                }, t.checkboxes), typeof n.template == B && (n.template = h(n.template)), t.checkboxes = n)
        },
        ...
        _updateNode: function (t, n) {
            ...
            if ("selected" == t) a = n[0], r = o.findByUid(a.uid).find(".k-in:first").removeClass("k-state-hover").toggleClass("k-state-selected", a[t]).end(), a[t] ? (o.current(r), r.attr(L, !0)) : r.attr(L, !1);
            else
                for (i = 0; n.length > i; i++) s.item = a = n[i], "spriteCssClass" == t || "imageUrl" == t || e.inArray(t, o.options.dataTextField) >= 0 ? o.findByUid(a.uid).find(">div>.k-in").html(o.templates.itemContent(s)) : t == T ? (r = o.findByUid(a.uid), r.children("div").find(":checkbox").prop(T, a[t]).data("indeterminate", !1).prop("indeterminate", !1), o._updateIndeterminate(r)) : "expanded" == t && o._toggle(o.findByUid(a.uid), a, a[t])
        },
        refresh: function (e) {
            function n(e, t) {
                var n = s(t),
                    i = n.children(),
                    a = !r._expanded(t);
                typeof c == z && (c = i.length), r._insertNode(e, c, t, function (e, t) {
            ...
            var i, r = this,
                ...
                u = r.options,
                p = u.loadOnDemand,
                f = u.checkboxes && u.checkboxes.checkChildren;
            if (e.field) return r._updateNode(e.field, d);
            if (o && (a = r.findByUid(o.uid), r._progress(a, !1)), f && "remove" != l && o && o.checked)
                for (i = 0; d.length > i; i++) d[i].checked = !0;
            for ("add" == l ? n(d, a) : "remove" == l ? r._remove(r.findByUid(d[0].uid), !1) : o ? (s(a).empty(), n(d, a)) : r.root = r.wrapper.html(r._renderGroup({
                items: d,
                group: {
                    firstLevel: !0,
                    expanded: !0
                }
            })).children("ul"), i = 0; d.length > i; i++)(!p || d[i].expanded) && d[i].load();
            r.trigger(A, {
                node: o ? a : t
            })
        },
        ...
        enable: function (e, t) {
            t = 2 == arguments.length ? !! t : !0, this._processNodes(e, function (e, n) {
                var i = !l(n).is(M),
                    r = this.dataItem(n);
                n.removeAttr(U), t || (r.selected && r.set("selected", !1), this.collapse(n), i = !0, n.removeAttr(L), n.attr(U, !0)), this._updateNodeClasses(n, {}, {
                    enabled: t,
                    expanded: !i
                })
            })
        ...
        _toggle: function (e, t, n) {
            var i, r = this,
                ...
                s = n ? "expand" : "collapse",
                d = a.animation[s];
            if (!o.data("animating") && !r._trigger(s, e))
                if (r._expanded(e, n), i = t && t.loaded(), i && o.children().length > 0) {
        ...
        _dataSourceMove: function (e, t, n, i) {
            var r, a, o, s = this._objectOrSelf(n || t),
                l = s.dataSource;
            if (n && n[0] != s.element[0] && (a = s.dataItem(n), a.loaded() || (s._progress(n, !0), a.load()), n != this.root && (l = a.children)), e = this._toObservableData(e), m(e) || e instanceof p.ObservableArray)
                for (o = 0; e.length > o; o++) r = i(l, e[o]);
            else r = i(l, e);
            return r && this.findByUid(r.uid)
        },
        _toObservableData: function (t) {
            var n, i, r = t;
            return (t instanceof window.jQuery || V(t)) && (n = this._objectOrSelf(t).dataSource, i = e(t).attr(c.attr("uid")), r = n.getByUid(i), r && (r = n.remove(r))), r
        },
        insertAfter: function (e, t) {
            var n, i = t.parent();
        ...
        _removeTouchHover: function () {
            var e = this;
            c.support.touch && e.hovered && (e.hovered.find("." + H).removeClass(H), e.hovered = !1)
        },
        ...
        drag: function (t) {
            ...
            v.length ? e.contains(m[0], g[0]) ? n = "k-denied" : (n = "k-insert-middle", i = g.closest(".k-top,.k-mid,.k-bot"), i.length ? (a = i.outerHeight(), o = i.offset().top, s = g.closest(".k-in"), l = a / (s.length > 0 ? 4 : 2), d = o + l > t.y.location, u = t.y.location > o + a - l, f._removeTouchHover(), p = s.length && !d && !u, f.hovered = p ? v : !1, f.dropHint.css(R, p ? "hidden" : "visible"), s.toggleClass(H, p), p ? n = "k-add" : (r = i.position(), r.top += d ? 0 : a, f.dropHint.css(r)[d ? "prependTo" : "appendTo"](g.closest(P).children("div:first")), d && i.hasClass("k-top") && (n = "k-insert-top"), u && i.hasClass("k-bot") && (n = "k-insert-bottom"))) : g[0] != f.dropHint[0] && (n = v[0] != h.element[0] ? "k-add" : "k-denied")) : (n = "k-denied", f._removeTouchHover()), h.trigger(D, {
                sourceNode: m[0],
                dropTarget: g[0],
                pageY: t.y.location,
                pageX: t.x.location,
        ...
        dragend: function () {
            var e, n, i, r = this,
                ...
                l = r.dropHint,
                d = r.dropTarget;
            return "visible" == l.css(R) ? (o = l.prevAll(".k-in").length > 0 ? "after" : "before", e = l.closest(P)) : d && (e = d.closest(P), e.length || (e = d.closest(".k-treeview"))), n = "k-denied" != r._hintStatus(), i = a.trigger(E, {
                sourceNode: s[0],
                destinationNode: e[0],
                valid: n,
                setValid: function (e) {
                ...
                dropTarget: d[0],
                dropPosition: o
            }), l.remove(), r._removeTouchHover(), !n || i ? (r._draggable.dropped = n, t) : (r._draggable.dropped = !0, "over" == o ? s = a.append(s, e) : "before" == o ? s = a.insertBefore(s, e) : "after" == o && (s = a.insertAfter(s, e)), a.trigger(N, {
                sourceNode: s && s[0],
                destinationNode: e[0],
                dropPosition: o
            }), t)
...
function (e, t) {
    ...
    var p = window.kendo,
        ...
        q = f.extend({
            init: function (e, t) {
                ...
                "none" != t.tickPlacement && i >= 2 && (n._trackDiv.before(r(t, n._distance)), n._setItemsWidth(a), n._setItemsTitle(), n._setItemsLargeTick()), n._calculateSteps(a), n._tabindex(n.wrapper.find(H)), n[t.enabled ? "enable" : "disable"]();
            ...
            _setItemsLargeTick: function () {
                ...
                if (0 === 1e3 * i.largeStep % (1e3 * i.smallStep))
                    if (n._isHorizontal && !n._isRtl)
                        for (t = 0; r.length > t; t = d(t + o)) a = e(r[t]), a.addClass("k-tick-large").html("<span class='k-label'>" + a.attr("title") + "</span>");
                    else
                        for (t = r.length - 1; t >= 0; t = d(t - o)) a = e(r[t]), a.addClass("k-tick-large").html("<span class='k-label'>" + a.attr("title") + "</span>"), n._isRtl || 0 !== t && t !== r.length - 1 && a.css("line-height", a[n._size]() + "px")
            },
            ...
            _getValueFromPosition: function (e, t) {
                ...
                for (n = 0; i._pixelSteps.length > n; n++)
                    if (s >= b.abs(i._pixelSteps[n] - o) - 1) return d(i._values[n])
            },
            ...
            _focus: function (t) {
                var n = this,
                    ...
                    r = n.value(),
                    a = n._drag;
                a || (i == n.wrapper.find(H).eq(0)[0] ? (a = n._firstHandleDrag, n._activeHandle = 0) : (a = n._lastHandleDrag, n._activeHandle = 1), r = r[n._activeHandle]), e(i).addClass(P), a && (n._activeHandleDrag = a, a.selectionStart = n.options.selectionStart, a.selectionEnd = n.options.selectionEnd, a._updateTooltip(r))
            },
            _focusWithMouse: function (t) {
                ...
                window.setTimeout(function () {
                    n.wrapper.find(H)[2 == r ? 1 : 0].focus()
    ...
    var $ = q.extend({
        init: function (n, i) {
            ...
            n.type = "text", i = m({}, {
                ...
                max: c(n, "max"),
                smallStep: c(n, "step")
            }, i), n = e(n), i && i.enabled === t && (i.enabled = !n.is("[disabled]")), q.fn.init.call(a, n, i), i = a.options, u(i.value) || (i.value = i.min, n.val(i.min)), i.value = b.max(b.min(i.value, i.max), i.min), r = a.wrapper.find(H), new $.Selection(r, a, i), a._drag = new $.Drag(r, "", a, i)
        },
        options: {
            name: "Slider",
            showButtons: !0,
        ...
        enable: function (n) {
            ...
            if (a.disable(), n !== !1) {
                ...
                }), a.wrapper.find(H).on(D, function () {
                    a._setTooltipTimeout()
                }).on(A, function (e) {
                    a._focusWithMouse(e), e.preventDefault()
                }).on(R, _(a._focus, a)).on(z, _(a._blur, a)), r = _(function (e) {
        ...
        _refreshAriaAttr: function (e) {
            var t, n = this,
                i = n._drag;
            t = i && i._tooltipDiv ? i._tooltipDiv.text() : n._getFormattedValue(e, null), this.wrapper.find(H).attr("aria-valuenow", e).attr("aria-valuetext", t)
        },
        ...
        destroy: function () {
            var e = this;
            f.fn.destroy.call(e), e.wrapper.off(T).find(".k-button").off(T).end().find(H).off(T).end().find(M + ", " + O).off(T).end(), e._drag.draggable.destroy()
        }
    });
    $.Selection = function (e, t, n) {
        ...
        moveTooltip: function () {
            ...
            i.type ? (e = r.wrapper.find(H), t = e.eq(0).offset(), n = e.eq(1).offset(), r._isHorizontal ? (a = n.top, o = t.left + (n.left - t.left) / 2) : (a = t.top + (n.top - t.top) / 2, o = n.left)) : (a = s.top, o = s.left), r._isHorizontal ? (o -= parseInt((i.tooltipDiv.outerWidth() - i.dragHandle[r._outerSize]()) / 2, 10), a -= i.tooltipDiv.outerHeight() + (d.height() || 0) + l) : (a -= parseInt((i.tooltipDiv.outerHeight() - i.dragHandle[r._outerSize]()) / 2, 10), o -= i.tooltipDiv.outerWidth() + (d.width() || 0) + l), i.tooltipDiv.css({
                top: a,
                left: o
            })
        },
    ...
    var G = q.extend({
        init: function (n, i) {
            ...
            o.type = "text", s.type = "text", i = m({}, {
                ...
                max: c(s, "max"),
                smallStep: c(s, "step")
            }, i), i && i.enabled === t && (i.enabled = !a.is("[disabled]")), q.fn.init.call(r, n, i), i = r.options, u(i.selectionStart) || (i.selectionStart = i.min, a.eq(0).val(i.min)), u(i.selectionEnd) || (i.selectionEnd = i.max, a.eq(1).val(i.max));
            var l = r.wrapper.find(H);
        ...
        enable: function (n) {
            ...
            r.disable(), n !== !1 && (r.wrapper.removeClass(L).addClass(B), r.wrapper.find("input").removeAttr(W), i = function (n) {
                ...
                return c.hasClass("k-draghandle") ? (c.addClass(P), t) : (a.selectionStart > d ? (r._setValueInRange(d, a.selectionEnd), r._firstHandleDrag.dragstart(n), i = 0) : d > r.selectionEnd ? (r._setValueInRange(a.selectionStart, d), r._lastHandleDrag.dragstart(n), i = 1) : a.selectionEnd - d >= d - a.selectionStart ? (r._setValueInRange(d, a.selectionEnd), r._firstHandleDrag.dragstart(n), i = 0) : (r._setValueInRange(a.selectionStart, d), r._lastHandleDrag.dragstart(n), i = 1), r._focusWithMouse({
                    target: r.wrapper.find(H)[i]
                }), t)
            }, r.wrapper.find(M + ", " + O).on(F, i).end().on(F, function () {
                e(document.documentElement).one("selectstart", p.preventDefault)
            }), r.wrapper.find(H).on(D, function () {
                r._setTooltipTimeout()
            }).on(A, function (e) {
                r._focusWithMouse(e), e.preventDefault()
            }).on(R, _(r._focus, r)).on(z, _(r._blur, r)), r.wrapper.find(H).off(N, p.preventDefault).eq(0).on(N, _(function (e) {
                this._keydown(e, "firstHandle")
            }, r)).end().eq(1).on(N, _(function (e) {
                this._keydown(e, "lastHandle")
            }, r)), r.options.enabled = !0)
        },
        disable: function () {
            var e = this;
            e.wrapper.removeClass(B).addClass(L), e.wrapper.find("input").attr(W, W), e.wrapper.find(M + ", " + O).off(F), e.wrapper.find(H).off(D).off(N).off(A).off(R).off(z), e.options.enabled = !1
        },
        ...
        _setZIndex: function (t) {
            this.wrapper.find(H).each(function (n) {
                e(this).css("z-index", "firstHandle" == t ? 1 - n : n)
            })
        },
        destroy: function () {
            var e = this;
            f.fn.destroy.call(e), e.wrapper.off(T).find(M + ", " + O).off(T).end().find(H).off(T), e._firstHandleDrag.draggable.destroy(), e._lastHandleDrag.draggable.destroy()
        }
    });
...
function (e, t) {
    ...
    function o(e) {
        var t = this,
            n = e.orientation;
        t.owner = e, t._element = e.element, t.orientation = n, c(t, n === w ? I : A), t._resizable = new s.ui.Resizable(e.element, {
            orientation: n,
    ...
    var m = window.kendo,
        ...
        D = g.extend({
            init: function (t, n) {
                ...
                r.closest("form").on("submit" + a, e.proxy(i._onParentFormSubmit, i)).on("reset" + a, e.proxy(i._onParentFormReset, i)), i.options.async.saveUrl ? (i._module = i._supportsFormData() ? new A(i) : new N(i), i._async = !0) : i._module = new E(i), i._supportsDrop() && i._setupDropZone(), i.wrapper.delegate(".k-upload-action", "click", e.proxy(i._onFileAction, i)).delegate(".k-upload-selected", "click", e.proxy(i._onUploadSelected, i)).delegate(".k-file", "t:progress", e.proxy(i._onFileProgress, i)).delegate(".k-file", "t:upload-success", e.proxy(i._onUploadSuccess, i)).delegate(".k-file", "t:upload-error", e.proxy(i._onUploadError, i))
            },
    ...
    A.prototype = {
        ...
        enqueueFiles: function (t) {
            ...
            if (o.options.async.batch === !0) n = e.map(t, function (e) {
                ...
                for (i = 0; s > i; i++) r = t[i], n = r.name, a = o._enqueueFile(n, {
                    fileNames: [r]
...
function (e, t) {
    ...
    function a(t) {
        return e(b).filter(function () {
            var n = e(this),
                i = r(n, t);
            return i.options.modal && n.is(N) && i.options.visible
        }).sort(function (t, n) {
    ...
    function o(e, t) {
        return function () {
            ...
            if (!r.isMaximized && !r.isMinimized) return e.restoreOptions = {
                width: i.width,
                height: i.height
            }, n.find(C).hide().end().find(q).parent().hide().eq(0).before(d.action({
                name: "Restore"
            })), t.call(e), e
        }
    }
    ...
    var d, c = window.kendo,
        ...
        W = "overflow",
        V = "zIndex",
        q = ".k-window-actions .k-i-minimize,.k-window-actions .k-i-maximize",
        ...
        G = u.extend({
                init: function (t, i) {
                    ...
                    u.fn.init.call(C, t, i), i = C.options, t = C.element, m = i.content, C.appendTo = e(i.appendTo || document.body), C._animations(), m && !f(m) && (m = i.content = {
                        url: m
                    }), t.parent().is(C.appendTo) || (t.find("script").remove(), t.is(N) ? (a = t.offset(), T = !0) : (o = t.css("visibility"), p = t.css("display"), t.css({
                        visibility: A,
                        display: ""
                    }), a = t.offset(), t.css({
                        visibility: o,
                        display: p
                    }))), n(i.visible) || (i.visible = t.is(N)), r = C.wrapper = t.closest(b), t.is(".k-content") && r[0] || (t.addClass("k-window-content k-content"), C._createWindow(t, i), r = C.wrapper = t.closest(b), C._dimensions()), a && r.css({
                        top: a.top,
                        left: a.left
                    }), m && C.refresh(m), C.toFront(), v = r.children(x), C._tabindex(v), i.visible && i.modal && C._overlay(r.is(N)).css({
                        opacity: .5
...
$(window).load(function () {
    ...
    if (bodyid == "fr") {
        $(".k-grid-pager").each(function () {
            $(this).children("a")[0].title = "Aller à  la premiére";
            $(this).children("a")[1].title = "Aller à  la page précédente";
            $(this).children("a")[2].title = "Aller à la page suivante";
            $(this).children("a")[3].title = "Aller à  la page précédente";
        })

    };
    if (bodyid == "es") {
        $(".k-grid-pager").each(function () {
            $(this).children("a")[0].title = "Ir a la primera página";
            $(this).children("a")[1].title = "Ir a la página anterior";
            $(this).children("a")[2].title = "Ir a la página siguiente";
            $(this).children("a")[3].title = "Ir a la última página";
        })
